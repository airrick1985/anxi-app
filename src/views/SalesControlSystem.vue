...
// ✅ 欄位定義已抽至 @/constants/householdColumns.js（與銷售圖面編輯器共用）
...
// ✅ UNIT_EXPORT_COMPUTED_COLUMNS 已抽至 @/constants/householdColumns.js
...
// ✅ [新增] 銷售圖面編輯器（docs/銷售圖面編輯器-spec.md）
function goToSalesDrawings() {
  router.push({ name: 'SalesDrawingList', params: { projectId: projectId.value } });
}
