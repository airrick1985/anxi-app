import{q as X_}from"./vendor-Bwt_tvmf.js";const J_=()=>{};var Zc={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nt(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function Ii(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rd=function(n){let e={},t={},s={},r="";try{const i=n.split(".");e=Ws(zo(i[0])||""),t=Ws(zo(i[1])||""),r=i[2],s=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:s,signature:r}},Em=function(n){const e=rd(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},Tm=function(n){const e=rd(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Im=function(n){const e=[];let t=0;for(let s=0;s<n.length;s++){let r=n.charCodeAt(s);if(r>=55296&&r<=56319){const i=r-55296;s++,V(s<n.length,"Surrogate pair missing trail surrogate.");const a=n.charCodeAt(s)-56320;r=65536+(i<<10)+a}r<128?e[t++]=r:r<2048?(e[t++]=r>>6|192,e[t++]=r&63|128):r<65536?(e[t++]=r>>12|224,e[t++]=r>>6&63|128,e[t++]=r&63|128):(e[t++]=r>>18|240,e[t++]=r>>12&63|128,e[t++]=r>>6&63|128,e[t++]=r&63|128)}return e},Ri=function(n){let e=0;for(let t=0;t<n.length;t++){const s=n.charCodeAt(t);s<128?e++:s<2048?e+=2:s>=55296&&s<=56319?(e+=4,t++):e+=3}return e};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dm{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Vm(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function Vm(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Go="@firebase/app",nu="0.14.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zr=new Map,lg=new Map,Qo=new Map;function su(n,e){try{n.container.addComponent(e)}catch(t){Rt.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function pn(n){const e=n.name;if(Qo.has(e))return Rt.debug(`There were multiple attempts to register component ${e}.`),!1;Qo.set(e,n);for(const t of Zr.values())su(t,n);for(const t of lg.values())su(t,n);return!0}function Ci(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function Si(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xa=og;function id(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const s={name:Ko,automaticDataCollectionEnabled:!0,...e},r=s.name;if(typeof r!="string"||!r)throw Ut.create("bad-app-name",{appName:String(r)});if(t||(t=ed()),!t)throw Ut.create("no-options");const i=Zr.get(r);if(i){if(zs(t,i.options)&&zs(s,i.config))return i;throw Ut.create("duplicate-app",{appName:r})}const a=new Sm(r);for(const u of Qo.values())a.addComponent(u);const l=new ug(t,s,a);return Zr.set(r,l),l}function bi(n=Ko){const e=Zr.get(n);if(!e&&n===Ko&&ed())return id();if(!e)throw Ut.create("no-app",{appName:n});return e}function nt(n,e,t){let s=ag[n]??n;t&&(s+=`-${t}`);const r=s.match(/\s|\//),i=e.match(/\s|\//);if(r||i){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&i&&a.push("and"),i&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Rt.warn(a.join(" "));return}pn(new Wt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tg(n){pn(new Wt("platform-logger",e=>new Dm(e),"PRIVATE")),pn(new Wt("heartbeat",e=>new mg(e),"PRIVATE")),nt(Go,nu,n),nt(Go,nu,"esm2020"),nt("fire-js","")}Tg("");var vg="firebase",wg="12.2.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class La{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(4.129032258064516);let s="";for(;s.length<20;){const r=Pg(40);for(let i=0;i<r.length;++i)s.length<20&&r[i]<t&&(s+=e.charAt(r[i]%62))}return s}}function z(n,e){return n<e?-1:n>e?1:0}function Xo(n,e){const t=Math.min(n.length,e.length);for(let s=0;s<t;s++){const r=n.charAt(s),i=e.charAt(s);if(r!==i)return No(r)===No(i)?z(r,i):No(r)?1:-1}return z(n.length,e.length)}const Ng=55296,kg=57343;function No(n){const e=n.charCodeAt(0);return e>=Ng&&e<=kg}function jn(n,e,t){return n.length===e.length&&n.every((s,r)=>t(s,e[r]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jo="__name__";class lt{constructor(e,t,s){t===void 0?t=0:t>e.length&&F(637,{offset:t,range:e.length}),s===void 0?s=e.length-t:s>e.length-t&&F(1746,{length:s,range:e.length-t}),this.segments=e,this.offset=t,this.len=s}get length(){return this.len}isEqual(e){return lt.comparator(this,e)===0}child(e){const t=this.segments.slice(this.offset,this.limit());return e instanceof lt?e.forEach(s=>{t.push(s)}):t.push(e),this.construct(t)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}forEach(e){for(let t=this.offset,s=this.limit();t<s;t++)e(this.segments[t])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,t){const s=Math.min(e.length,t.length);for(let r=0;r<s;r++){const i=lt.compareSegments(e.get(r),t.get(r));if(i!==0)return i}return z(e.length,t.length)}static compareSegments(e,t){const s=lt.isNumericId(e),r=lt.isNumericId(t);return s&&!r?-1:!s&&r?1:s&&r?lt.extractNumericId(e).compare(lt.extractNumericId(t)):Xo(e,t)}static isNumericId(e){return e.startsWith("__id")&&e.endsWith("__")}static extractNumericId(e){return Bt.fromString(e.substring(4,e.length-2))}}class re extends lt{construct(e,t,s){return new re(e,t,s)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...e){const t=[];for(const s of e){if(s.indexOf("//")>=0)throw new O(b.INVALID_ARGUMENT,`Invalid segment (${s}). Paths must not contain // in them.`);t.push(...s.split("/").filter(r=>r.length>0))}return new re(t)}static emptyPath(){return new re([])}}const Dg=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class be extends lt{construct(e,t,s){return new be(e,t,s)}static isValidIdentifier(e){return Dg.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),be.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)===Jo}static keyField(){return new be([Jo])}static fromServerFormat(e){const t=[];let s="",r=0;const i=()=>{if(s.length===0)throw new O(b.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);t.push(s),s=""};let a=!1;for(;r<e.length;){const l=e[r];if(l==="\\"){if(r+1===e.length)throw new O(b.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const u=e[r+1];if(u!=="\\"&&u!=="."&&u!=="`")throw new O(b.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);s+=u,r+=2}else l==="`"?(a=!a,r++):l!=="."||a?(s+=l,r++):(i(),r++)}if(i(),a)throw new O(b.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new be(t)}static emptyPath(){return new be([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fa=-1;function ki(n){return n==null}function ei(n){return n===0&&1/n==-1/0}function Bg(n){return typeof n=="number"&&Number.isInteger(n)&&!ei(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vd="server_timestamp",wd="__type__",Id="__previous_value__",Ad="__local_write_time__";function Ua(n){var t,s;return((s=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[wd])==null?void 0:s.stringValue)===vd}function Di(n){const e=n.mapValue.fields[Id];return Ua(e)?Di(e):e}function Ks(n){const e=Ht(n.mapValue.fields[Ad].timestampValue);return new ae(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zg{constructor(e,t,s,r,i,a,l,u,h,f){this.databaseId=e,this.appId=t,this.persistenceKey=s,this.host=r,this.ssl=i,this.forceLongPolling=a,this.autoDetectLongPolling=l,this.longPollingOptions=u,this.useFetchStreams=h,this.isUsingEmulator=f}}const ti="(default)";class Qs{constructor(e,t){this.projectId=e,this.database=t||ti}static empty(){return new Qs("","")}get isDefaultDatabase(){return this.database===ti}isEqual(e){return e instanceof Qs&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mi{constructor(){this._=void 0}}function _y(n,e,t){return n instanceof Js?function(r,i){const a={fields:{[wd]:{stringValue:vd},[Ad]:{timestampValue:{seconds:r.seconds,nanos:r.nanoseconds}}}};return i&&Ua(i)&&(i=Di(i)),i&&(a.fields[Id]=i),{mapValue:a}}(t,e):n instanceof Zs?$d(n,e):n instanceof er?Wd(n,e):function(r,i){const a=jd(r,i),l=Su(a)+Su(r.Ae);return ta(a)&&ta(r.Ae)?qd(l):$a(r.serializer,l)}(n,e)}function my(n,e,t){return n instanceof Zs?$d(n,e):n instanceof er?Wd(n,e):t}function jd(n,e){return n instanceof ii?function(s){return ta(s)||function(i){return!!i&&"doubleValue"in i}(s)}(e)?e:{integerValue:0}:null}class Js extends Mi{}class Zs extends Mi{constructor(e){super(),this.elements=e}}function $d(n,e){const t=zd(e);for(const s of n.elements)t.some(r=>mt(r,s))||t.push(s);return{arrayValue:{values:t}}}class er extends Mi{constructor(e){super(),this.elements=e}}function Wd(n,e){let t=zd(e);for(const s of n.elements)t=t.filter(r=>!mt(r,s));return{arrayValue:{values:t}}}class ii extends Mi{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function Su(n){return pe(n.integerValue||n.doubleValue)}function zd(n){return Ba(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ui{constructor(e,t,s,r,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=s,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,s){const r=new Map;return r.set(e,or.createSynthesizedTargetChangeForCurrentChange(e,t,s)),new Ui(j.min(),r,new Te(z),St(),G())}}class or{constructor(e,t,s,r,i){this.resumeToken=e,this.current=t,this.addedDocuments=s,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,s){return new or(s,t,G(),G(),G())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ky{constructor(e){this.yt=e}}function Qy(n){const e=jy({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?ri(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Do="RestConnection",SE={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class bE{get $o(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.Uo=t+"://"+e.host,this.Ko=`projects/${s}/databases/${r}`,this.Wo=this.databaseId.database===ti?`project_id=${s}`:`project_id=${s}&database_id=${r}`}Go(e,t,s,r,i){const a=ua(),l=this.zo(e,t.toUriEncodedString());x(Do,`Sending RPC '${e}' ${a}:`,l,s);const u={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Wo};this.jo(u,r,i);const{host:h}=new URL(l),f=Nt(h);return this.Jo(e,l,u,s,f).then(p=>(x(Do,`Received RPC '${e}' ${a}: `,p),p),p=>{throw qn(Do,`RPC '${e}' ${a} failed with error: `,p,"url: ",l,"request:",s),p})}Ho(e,t,s,r,i,a){return this.Go(e,t,s,r,i)}jo(e,t,s){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Jn}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((r,i)=>e[i]=r),s&&s.headers.forEach((r,i)=>e[i]=r)}zo(e,t){const s=SE[e];return`${this.Uo}/v1/${t}:${s}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bi(n){return new Oy(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rs{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new O(b.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new be(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}function mR(){return new rs(Jo)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class UT{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=cr(e)}set(e,t,s){this._verifyNotCommitted();const r=xo(e,this._firestore),i=vl(r.converter,t,s),a=dl(this._dataReader,"WriteBatch.set",r._key,i,r.converter!==null,s);return this._mutations.push(a.toMutation(r._key,je.none())),this}update(e,t,s,...r){this._verifyNotCommitted();const i=xo(e,this._firestore);let a;return a=typeof(t=le(t))=="string"||t instanceof rs?kf(this._dataReader,"WriteBatch.update",i._key,t,s,r):Nf(this._dataReader,"WriteBatch.update",i._key,t),this._mutations.push(a.toMutation(i._key,je.exists(!0))),this}delete(e){this._verifyNotCommitted();const t=xo(e,this._firestore);return this._mutations=this._mutations.concat(new Fi(t._key,je.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new O(b.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function xo(n,e){if((n=le(n)).firestore!==e)throw new O(b.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return n}function PR(){return new fl("serverTimestamp")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ew{constructor(e,t,s,r){this.app=e,this.auth=null,this.messaging=null,this.appCheck=null,this.serverAppAppCheckToken=null,Si(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.auth=t.getImmediate({optional:!0}),this.messaging=s.getImmediate({optional:!0}),this.auth||t.get().then(i=>this.auth=i,()=>{}),this.messaging||s.get().then(i=>this.messaging=i,()=>{}),this.appCheck||r==null||r.get().then(i=>this.appCheck=i,()=>{})}async getAuthToken(){if(this.auth)try{const e=await this.auth.getToken();return e==null?void 0:e.accessToken}catch{return}}async getMessagingToken(){if(!(!this.messaging||!("Notification"in self)||Notification.permission!=="granted"))try{return await this.messaging.getToken()}catch{return}}async getAppCheckToken(e){if(this.serverAppAppCheckToken)return this.serverAppAppCheckToken;if(this.appCheck){const t=e?await this.appCheck.getLimitedUseToken():await this.appCheck.getToken();return t.error?null:t.token}return null}async getContext(e){const t=await this.getAuthToken(),s=await this.getMessagingToken(),r=await this.getAppCheckToken(e);return{authToken:t,messagingToken:s,appCheckToken:r}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ma="us-central1",tw=/^data: (.*?)(?:\n|$)/;function nw(n){let e=null;return{promise:new Promise((t,s)=>{e=setTimeout(()=>{s(new He("deadline-exceeded","deadline-exceeded"))},n)}),cancel:()=>{e&&clearTimeout(e)}}}class sw{constructor(e,t,s,r,i=ma,a=(...l)=>fetch(...l)){this.app=e,this.fetchImpl=a,this.emulatorOrigin=null,this.contextProvider=new ew(e,t,s,r),this.cancelAllRequests=new Promise(l=>{this.deleteService=()=>Promise.resolve(l())});try{const l=new URL(i);this.customDomain=l.origin+(l.pathname==="/"?"":l.pathname),this.region=ma}catch{this.customDomain=null,this.region=i}}_delete(){return this.deleteService()}_url(e){const t=this.app.options.projectId;return this.emulatorOrigin!==null?`${this.emulatorOrigin}/${t}/${this.region}/${e}`:this.customDomain!==null?`${this.customDomain}/${e}`:`https://${this.region}-${t}.cloudfunctions.net/${e}`}}function rw(n,e,t){const s=Nt(e);n.emulatorOrigin=`http${s?"s":""}://${e}:${t}`,s&&(Ii(n.emulatorOrigin+"/backends"),Ai("Functions",!0))}function iw(n,e,t){const s=r=>aw(n,e,r,{});return s.stream=(r,i)=>cw(n,e,r,i),s}function sp(n){return n.emulatorOrigin&&Nt(n.emulatorOrigin)?"include":void 0}async function ow(n,e,t,s,r){t["Content-Type"]="application/json";let i;try{i=await s(n,{method:"POST",body:JSON.stringify(e),headers:t,credentials:sp(r)})}catch{return{status:0,json:null}}let a=null;try{a=await i.json()}catch{}return{status:i.status,json:a}}async function rp(n,e){const t={},s=await n.contextProvider.getContext(e.limitedUseAppCheckTokens);return s.authToken&&(t.Authorization="Bearer "+s.authToken),s.messagingToken&&(t["Firebase-Instance-ID-Token"]=s.messagingToken),s.appCheckToken!==null&&(t["X-Firebase-AppCheck"]=s.appCheckToken),t}function aw(n,e,t,s){const r=n._url(e);return lw(n,r,t,s)}async function lw(n,e,t,s){t=di(t);const r={data:t},i=await rp(n,s),a=s.timeout||7e4,l=nw(a),u=await Promise.race([ow(e,r,i,n.fetchImpl,n),l.promise,n.cancelAllRequests]);if(l.cancel(),!u)throw new He("cancelled","Firebase Functions instance was deleted.");const h=fi(u.status,u.json);if(h)throw h;if(!u.json)throw new He("internal","Response is not valid JSON object.");let f=u.json.data;if(typeof f>"u"&&(f=u.json.result),typeof f>"u")throw new He("internal","Response is missing data field.");return{data:Gn(f)}}function cw(n,e,t,s){const r=n._url(e);return uw(n,r,t,s||{})}async function uw(n,e,t,s){var m;t=di(t);const r={data:t},i=await rp(n,s);i["Content-Type"]="application/json",i.Accept="text/event-stream";let a;try{a=await n.fetchImpl(e,{method:"POST",body:JSON.stringify(r),headers:i,signal:s==null?void 0:s.signal,credentials:sp(n)})}catch(I){if(I instanceof Error&&I.name==="AbortError"){const k=new He("cancelled","Request was cancelled.");return{data:Promise.reject(k),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(k)}}}}}}const C=fi(0,null);return{data:Promise.reject(C),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(C)}}}}}}let l,u;const h=new Promise((I,C)=>{l=I,u=C});(m=s==null?void 0:s.signal)==null||m.addEventListener("abort",()=>{const I=new He("cancelled","Request was cancelled.");u(I)});const f=a.body.getReader(),p=hw(f,l,u,s==null?void 0:s.signal);return{stream:{[Symbol.asyncIterator](){const I=p.getReader();return{async next(){const{value:C,done:k}=await I.read();return{value:C,done:k}},async return(){return await I.cancel(),{done:!0,value:void 0}}}}},data:h}}function hw(n,e,t,s){const r=(a,l)=>{const u=a.match(tw);if(!u)return;const h=u[1];try{const f=JSON.parse(h);if("result"in f){e(Gn(f.result));return}if("message"in f){l.enqueue(Gn(f.message));return}if("error"in f){const p=fi(0,f);l.error(p),t(p);return}}catch(f){if(f instanceof He){l.error(f),t(f);return}}},i=new TextDecoder;return new ReadableStream({start(a){let l="";return u();async function u(){if(s!=null&&s.aborted){const h=new He("cancelled","Request was cancelled");return a.error(h),t(h),Promise.resolve()}try{const{value:h,done:f}=await n.read();if(f){l.trim()&&r(l.trim(),a),a.close();return}if(s!=null&&s.aborted){const m=new He("cancelled","Request was cancelled");a.error(m),t(m),await n.cancel();return}l+=i.decode(h,{stream:!0});const p=l.split(`
`);l=p.pop()||"";for(const m of p)m.trim()&&r(m.trim(),a);return u()}catch(h){const f=h instanceof He?h:fi(0,null);a.error(f),t(f)}}},cancel(){return n.cancel()}})}const dh="@firebase/functions",fh="0.13.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mw(n=bi(),e=ma){const s=Ci(le(n),Sl).getImmediate({identifier:e}),r=wi("functions");return r&&gw(s,...r),s}function gw(n,e,t){rw(le(n),e,t)}function OR(n,e,t){return iw(le(n),e)}_w();var ph={};const _h="@firebase/database",mh="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vw{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,Si(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(s=>this.appCheck=s)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,s)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)==null||t.get().then(s=>s.addTokenListener(e))}notifyForInvalidToken(){Ke(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fo={},Uo={};function Nl(n){const e=n.toString();return Fo[e]||(Fo[e]=new Mw),Fo[e]}function Lw(n,e){const t=n.toString();return Uo[t]||(Uo[t]=e()),Uo[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yi{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const s=new Y(Kn,e),r=new Y(Kn,t);return this.compare(s,r)!==0}minPost(){return Y.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let jr;class kp extends Yi{static get __EMPTY_NODE(){return jr}static set __EMPTY_NODE(e){jr=e}compare(e,t){return In(e.name,t.name)}isDefinedOn(e){throw Xn("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Y.MIN}maxPost(){return new Y(yn,jr)}makePost(e,t){return V(typeof e=="string","KeyIndex indexValue must always be a string."),new Y(e,jr)}toString(){return".key"}}const Fn=new kp;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qo;const Nn={};class It{static get Default(){return V(Nn&&Pe,"ChildrenNode.ts has not been loaded"),qo=qo||new It({".priority":Nn},{".priority":Pe}),qo}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=Un(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Ge?t:null}hasIndex(e){return gt(this.indexSet_,e.toString())}addIndex(e,t){V(e!==Fn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let r=!1;const i=t.getIterator(Y.Wrap);let a=i.getNext();for(;a;)r=r||e.isDefinedOn(a.node),s.push(a),a=i.getNext();let l;r?l=mi(s,e.getCompare()):l=Nn;const u=e.toString(),h={...this.indexSet_};h[u]=e;const f={...this.indexes_};return f[u]=l,new It(f,h)}addToIndexes(e,t){const s=Jr(this.indexes_,(r,i)=>{const a=Un(this.indexSet_,i);if(V(a,"Missing index implementation for "+i),r===Nn)if(a.isDefinedOn(e.node)){const l=[],u=t.getIterator(Y.Wrap);let h=u.getNext();for(;h;)h.name!==e.name&&l.push(h),h=u.getNext();return l.push(e),mi(l,a.getCompare())}else return Nn;else{const l=t.get(e.name);let u=r;return l&&(u=u.remove(new Y(e.name,l))),u.insert(e,e.node)}});return new It(s,this.indexSet_)}removeFromIndexes(e,t){const s=Jr(this.indexes_,r=>{if(r===Nn)return r;{const i=t.get(e.name);return i?r.remove(new Y(e.name,i)):r}});return new It(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class CI extends Yi{compare(e,t){const s=e.node.compareTo(t.node);return s===0?In(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Y.MIN}maxPost(){return Y.MAX}makePost(e,t){const s=ge(e);return new Y(t,s)}toString(){return".value"}}const SI=new CI;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yi(){return{value:null,children:new Map}}function os(n,e,t){if(H(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const s=W(e);n.children.has(s)||n.children.set(s,yi());const r=n.children.get(s);e=se(e),os(r,e,t)}}function Ta(n,e){if(H(e))return n.value=null,n.children.clear(),!0;if(n.value!==null){if(n.value.isLeafNode())return!1;{const t=n.value;return n.value=null,t.forEachChild(Pe,(s,r)=>{os(n,new ne(s),r)}),Ta(n,e)}}else if(n.children.size>0){const t=W(e);return e=se(e),n.children.has(t)&&Ta(n.children.get(t),e)&&n.children.delete(t),n.children.size===0}else return!0}function va(n,e,t){n.value!==null?t(e,n.value):VI(n,(s,r)=>{const i=new ne(e.toString()+"/"+s);va(r,i,t)})}function VI(n,e){n.children.forEach((t,s)=>{e(s,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ei{constructor(e,t,s){this.path=e,this.affectedTree=t,this.revert=s,this.type=ut.ACK_USER_WRITE,this.source=Mp()}operationForChild(e){if(H(this.path)){if(this.affectedTree.value!=null)return V(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new ne(e));return new Ei(ee(),t,this.revert)}}else return V(W(this.path)===e,"operationForChild called for unrelated child."),new Ei(se(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AA=/[\[\].#$\/\u0000-\u001F\u007F]/,RA=/[\[\].#$\u0000-\u001F\u007F]/,$o=10*1024*1024,Gl=function(n){return typeof n=="string"&&n.length!==0&&!AA.test(n)},o_=function(n){return typeof n=="string"&&n.length!==0&&!RA.test(n)},CA=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),o_(n)},a_=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Qi(n)||n&&typeof n=="object"&&gt(n,".sv")},Pa=function(n,e,t,s){eo(Bn(n,"value"),e,t)},eo=function(n,e,t){const s=t instanceof ne?new lI(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+an(s));if(typeof e=="function")throw new Error(n+"contains a function "+an(s)+" with contents = "+e.toString());if(Qi(e))throw new Error(n+"contains "+e.toString()+" "+an(s));if(typeof e=="string"&&e.length>$o/3&&Ri(e)>$o)throw new Error(n+"contains a string greater than "+$o+" utf8 bytes "+an(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let r=!1,i=!1;if(Qe(e,(a,l)=>{if(a===".value")r=!0;else if(a!==".priority"&&a!==".sv"&&(i=!0,!Gl(a)))throw new Error(n+" contains an invalid key ("+a+") "+an(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);cI(s,a),eo(n,l,s),uI(s)}),r&&i)throw new Error(n+' contains ".value" child '+an(s)+" in addition to actual children.")}},SA=function(n,e){let t,s;for(t=0;t<e.length;t++){s=e[t];const i=nr(s);for(let a=0;a<i.length;a++)if(!(i[a]===".priority"&&a===i.length-1)){if(!Gl(i[a]))throw new Error(n+"contains an invalid key ("+i[a]+") in path "+s.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(aI);let r=null;for(t=0;t<e.length;t++){if(s=e[t],r!==null&&tt(r,s))throw new Error(n+"contains a path "+r.toString()+" that is ancestor of another path "+s.toString());r=s}},bA=function(n,e,t,s){const r=Bn(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(r+" must be an object containing the children to replace.");const i=[];Qe(e,(a,l)=>{const u=new ne(a);if(eo(r,l,_e(t,u)),Dl(u)===".priority"&&!a_(l))throw new Error(r+"contains an invalid value for '"+u.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");i.push(u)}),SA(r,i)},PA=function(n,e,t){if(Qi(e))throw new Error(Bn(n,"priority")+"is "+e.toString()+", but must be a valid Firebase priority (a string, finite number, server value, or null).");if(!a_(e))throw new Error(Bn(n,"priority")+"must be a valid Firebase priority (a string, finite number, server value, or null).")},l_=function(n,e,t,s){if(!o_(t))throw new Error(Bn(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},NA=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),l_(n,e,t)},xn=function(n,e){if(W(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},kA=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Gl(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!CA(t))throw new Error(Bn(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xA="repo_interrupt",MA=25;class LA{constructor(e,t,s,r){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=s,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new DA,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=yi(),this.transactionQueueTree_=new zl,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function FA(n,e,t){if(n.stats_=Nl(n.repoInfo_),n.forceRestClient_||Dw())n.server_=new gi(n.repoInfo_,(s,r,i,a)=>{Hh(n,s,r,i,a)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Gh(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Se(t)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}n.persistentConnection_=new At(n.repoInfo_,e,(s,r,i,a)=>{Hh(n,s,r,i,a)},s=>{Gh(n,s)},s=>{BA(n,s)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(s=>{n.server_.refreshAuthToken(s)}),n.appCheckProvider_.addTokenChangeListener(s=>{n.server_.refreshAppCheckToken(s.token)}),n.statsReporter_=Lw(n.repoInfo_,()=>new LI(n.stats_,n.server_)),n.infoData_=new DI,n.infoSyncTree_=new Wh({startListening:(s,r,i,a)=>{let l=[];const u=n.infoData_.getNode(s._path);return u.isEmpty()||(l=Xi(n.infoSyncTree_,s._path,u),setTimeout(()=>{a("ok")},0)),l},stopListening:()=>{}}),Ql(n,"connected",!1),n.serverSyncTree_=new Wh({startListening:(s,r,i,a)=>(n.server_.listen(s,i,r,(l,u)=>{const h=a(l,u);Pt(n.eventQueue_,s._path,h)}),[]),stopListening:(s,r)=>{n.server_.unlisten(s,r)}})}function UA(n){const t=n.infoData_.getNode(new ne(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Kl(n){return gA({timestamp:UA(n)})}function Hh(n,e,t,s,r){n.dataUpdateCount++;const i=new ne(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let a=[];if(r)if(s){const u=Jr(t,h=>ge(h));a=mA(n.serverSyncTree_,i,u,r)}else{const u=ge(t);a=_A(n.serverSyncTree_,i,u,r)}else if(s){const u=Jr(t,h=>ge(h));a=pA(n.serverSyncTree_,i,u)}else{const u=ge(t);a=Xi(n.serverSyncTree_,i,u)}let l=i;a.length>0&&(l=to(n,i)),Pt(n.eventQueue_,l,a)}function Gh(n,e){Ql(n,"connected",e),e===!1&&jA(n)}function BA(n,e){Qe(e,(t,s)=>{Ql(n,t,s)})}function Ql(n,e,t){const s=new ne("/.info/"+e),r=ge(t);n.infoData_.updateSnapshot(s,r);const i=Xi(n.infoSyncTree_,s,r);Pt(n.eventQueue_,s,i)}function u_(n){return n.nextWriteId_++}function qA(n,e,t,s,r){Yl(n,"set",{path:e.toString(),value:t,priority:s});const i=Kl(n),a=ge(t,s),l=ql(n.serverSyncTree_,e),u=n_(a,l,i),h=u_(n),f=Yp(n.serverSyncTree_,e,u,h,!0);c_(n.eventQueue_,f),n.server_.put(e.toString(),a.val(!0),(m,I)=>{const C=m==="ok";C||Ke("set at "+e+" failed: "+m);const k=un(n.serverSyncTree_,h,!C);Pt(n.eventQueue_,e,k),Yn(n,r,m,I)});const p=__(n,e);to(n,p),Pt(n.eventQueue_,p,[])}function jA(n){Yl(n,"onDisconnectEvents");const e=Kl(n),t=yi();va(n.onDisconnect_,ee(),(r,i)=>{const a=TA(r,i,n.serverSyncTree_,e);os(t,r,a)});let s=[];va(t,ee(),(r,i)=>{s=s.concat(Xi(n.serverSyncTree_,r,i));const a=__(n,r);to(n,a)}),n.onDisconnect_=yi(),Pt(n.eventQueue_,ee(),s)}function $A(n,e,t){n.server_.onDisconnectCancel(e.toString(),(s,r)=>{s==="ok"&&Ta(n.onDisconnect_,e),Yn(n,t,s,r)})}function Kh(n,e,t,s){const r=ge(t);n.server_.onDisconnectPut(e.toString(),r.val(!0),(i,a)=>{i==="ok"&&os(n.onDisconnect_,e,r),Yn(n,s,i,a)})}function WA(n,e,t,s,r){const i=ge(t,s);n.server_.onDisconnectPut(e.toString(),i.val(!0),(a,l)=>{a==="ok"&&os(n.onDisconnect_,e,i),Yn(n,r,a,l)})}function zA(n,e,t,s){if(Ho(t)){Ce("onDisconnect().update() called with empty data.  Don't do anything."),Yn(n,s,"ok",void 0);return}n.server_.onDisconnectMerge(e.toString(),t,(r,i)=>{r==="ok"&&Qe(t,(a,l)=>{const u=ge(l);os(n.onDisconnect_,_e(e,a),u)}),Yn(n,s,r,i)})}function HA(n){n.persistentConnection_&&n.persistentConnection_.interrupt(xA)}function Yl(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),Ce(t,...e)}function Yn(n,e,t,s){e&&is(()=>{if(t==="ok")e(null);else{const r=(t||"error").toUpperCase();let i=r;s&&(i+=": "+s);const a=new Error(i);a.code=r,e(a)}})}function h_(n,e,t){return ql(n.serverSyncTree_,e,t)||Z.EMPTY_NODE}function Xl(n,e=n.transactionQueueTree_){if(e||no(n,e),as(e)){const t=f_(n,e);V(t.length>0,"Sending zero length transaction queue"),t.every(r=>r.status===0)&&GA(n,_r(e),t)}else r_(e)&&Zi(e,t=>{Xl(n,t)})}function GA(n,e,t){const s=t.map(h=>h.currentWriteId),r=h_(n,e,s);let i=r;const a=r.hash();for(let h=0;h<t.length;h++){const f=t[h];V(f.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),f.status=1,f.retryCount++;const p=et(e,f.path);i=i.updateChild(p,f.currentOutputSnapshotRaw)}const l=i.val(!0),u=e;n.server_.put(u.toString(),l,h=>{Yl(n,"transaction put response",{path:u.toString(),status:h});let f=[];if(h==="ok"){const p=[];for(let m=0;m<t.length;m++)t[m].status=2,f=f.concat(un(n.serverSyncTree_,t[m].currentWriteId)),t[m].onComplete&&p.push(()=>t[m].onComplete(null,!0,t[m].currentOutputSnapshotResolved)),t[m].unwatcher();no(n,Hl(n.transactionQueueTree_,e)),Xl(n,n.transactionQueueTree_),Pt(n.eventQueue_,e,f);for(let m=0;m<p.length;m++)is(p[m])}else{if(h==="datastale")for(let p=0;p<t.length;p++)t[p].status===3?t[p].status=4:t[p].status=0;else{Ke("transaction at "+u.toString()+" failed: "+h);for(let p=0;p<t.length;p++)t[p].status=4,t[p].abortReason=h}to(n,e)}},a)}function to(n,e){const t=d_(n,e),s=_r(t),r=f_(n,t);return KA(n,r,s),s}function KA(n,e,t){if(e.length===0)return;const s=[];let r=[];const a=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const u=e[l],h=et(t,u.path);let f=!1,p;if(V(h!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),u.status===4)f=!0,p=u.abortReason,r=r.concat(un(n.serverSyncTree_,u.currentWriteId,!0));else if(u.status===0)if(u.retryCount>=MA)f=!0,p="maxretry",r=r.concat(un(n.serverSyncTree_,u.currentWriteId,!0));else{const m=h_(n,u.path,a);u.currentInputSnapshot=m;const I=e[l].update(m.val());if(I!==void 0){eo("transaction failed: Data returned ",I,u.path);let C=ge(I);typeof I=="object"&&I!=null&&gt(I,".priority")||(C=C.updatePriority(m.getPriority()));const N=u.currentWriteId,B=Kl(n),L=n_(C,m,B);u.currentOutputSnapshotRaw=C,u.currentOutputSnapshotResolved=L,u.currentWriteId=u_(n),a.splice(a.indexOf(N),1),r=r.concat(Yp(n.serverSyncTree_,u.path,L,u.currentWriteId,u.applyLocally)),r=r.concat(un(n.serverSyncTree_,N,!0))}else f=!0,p="nodata",r=r.concat(un(n.serverSyncTree_,u.currentWriteId,!0))}Pt(n.eventQueue_,t,r),r=[],f&&(e[l].status=2,function(m){setTimeout(m,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(p==="nodata"?s.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):s.push(()=>e[l].onComplete(new Error(p),!1,null))))}no(n,n.transactionQueueTree_);for(let l=0;l<s.length;l++)is(s[l]);Xl(n,n.transactionQueueTree_)}function d_(n,e){let t,s=n.transactionQueueTree_;for(t=W(e);t!==null&&as(s)===void 0;)s=Hl(s,t),e=se(e),t=W(e);return s}function f_(n,e){const t=[];return p_(n,e,t),t.sort((s,r)=>s.order-r.order),t}function p_(n,e,t){const s=as(e);if(s)for(let r=0;r<s.length;r++)t.push(s[r]);Zi(e,r=>{p_(n,r,t)})}function no(n,e){const t=as(e);if(t){let s=0;for(let r=0;r<t.length;r++)t[r].status!==2&&(t[s]=t[r],s++);t.length=s,s_(e,t.length>0?t:void 0)}Zi(e,s=>{no(n,s)})}function __(n,e){const t=_r(d_(n,e)),s=Hl(n.transactionQueueTree_,e);return wA(s,r=>{Wo(n,r)}),Wo(n,s),i_(s,r=>{Wo(n,r)}),t}function Wo(n,e){const t=as(e);if(t){const s=[];let r=[],i=-1;for(let a=0;a<t.length;a++)t[a].status===3||(t[a].status===1?(V(i===a-1,"All SENT items should be at beginning of queue."),i=a,t[a].status=3,t[a].abortReason="set"):(V(t[a].status===0,"Unexpected transaction status in abort"),t[a].unwatcher(),r=r.concat(un(n.serverSyncTree_,t[a].currentWriteId,!0)),t[a].onComplete&&s.push(t[a].onComplete.bind(null,new Error("set"),!1,null))));i===-1?s_(e,void 0):t.length=i+1,Pt(n.eventQueue_,_r(e),r);for(let a=0;a<s.length;a++)is(s[a])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
