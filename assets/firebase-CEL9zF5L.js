 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xt(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function wi(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _m="FirebaseError";class Jt extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=_m,Object.setPrototypeOf(this,Jt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,sd.prototype.create)}}class sd{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},r=`${this.service}/${e}`,i=this.errors[e],a=i?mm(i,s):"Error",l=`${this.serviceName}: ${a} (${r}).`;return new Jt(r,l,s)}}function mm(n,e){return n.replace(gm,(t,s)=>{const r=e[s];return r!=null?String(r):`<${s}?>`})}const gm=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xa=ig;function id(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const s={name:Go,automaticDataCollectionEnabled:!0,...e},r=s.name;if(typeof r!="string"||!r)throw Ft.create("bad-app-name",{appName:String(r)});if(t||(t=ed()),!t)throw Ft.create("no-options");const i=Zr.get(r);if(i){if(zs(t,i.options)&&zs(s,i.config))return i;throw Ft.create("duplicate-app",{appName:r})}const a=new Cm(r);for(const u of Ko.values())a.addComponent(u);const l=new cg(t,s,a);return Zr.set(r,l),l}function Si(n=Go){const e=Zr.get(n);if(!e&&n===Go&&ed())return id();if(!e)throw Ft.create("no-app",{appName:n});return e}function nt(n,e,t){let s=og[n]??n;t&&(s+=`-${t}`);const r=s.match(/\s|\//),i=e.match(/\s|\//);if(r||i){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&i&&a.push("and"),i&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Rt.warn(a.join(" "));return}pn(new $t(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eg(n){pn(new $t("platform-logger",e=>new km(e),"PRIVATE")),pn(new $t("heartbeat",e=>new _g(e),"PRIVATE")),nt(Ho,nu,n),nt(Ho,nu,"esm2020"),nt("fire-js","")}Eg("");var Tg="firebase",vg="12.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gs=-1;function Vg(n,e){const t=n.toTimestamp().seconds,s=n.toTimestamp().nanoseconds+1,r=j.fromTimestamp(s===1e9?new ae(t+1,0):new ae(t,s));return new Wt(r,M.empty(),e)}function Og(n){return new Wt(n.readTime,n.key,Gs)}class Wt{constructor(e,t,s){this.readTime=e,this.documentKey=t,this.largestBatchId=s}static min(){return new Wt(j.min(),M.empty(),Gs)}static max(){return new Wt(j.max(),M.empty(),Gs)}}function xg(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=M.comparator(n.documentKey,e.documentKey),t!==0?t:z(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fa=-1;function Ni(n){return n==null}function ei(n){return n===0&&1/n==-1/0}function Ug(n){return typeof n=="number"&&Number.isInteger(n)&&!ei(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vd="server_timestamp",wd="__type__",Id="__previous_value__",Ad="__local_write_time__";function Ua(n){var t,s;return((s=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[wd])==null?void 0:s.stringValue)===vd}function ki(n){const e=n.mapValue.fields[Id];return Ua(e)?ki(e):e}function Ks(n){const e=zt(n.mapValue.fields[Ad].timestampValue);return new ae(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sy{constructor(e,t=null,s=[],r=[],i=null,a=null,l=null){this.path=e,this.collectionGroup=t,this.orderBy=s,this.filters=r,this.limit=i,this.startAt=a,this.endAt=l,this.Te=null}}function Ru(n,e=null,t=[],s=[],r=null,i=null,a=null){return new sy(n,e,t,s,r,i,a)}function qa(n){const e=q(n);if(e.Te===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(s=>na(s)).join(","),t+="|ob:",t+=e.orderBy.map(s=>function(i){return i.field.canonicalString()+i.dir}(s)).join(","),Ni(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(s=>Wn(s)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(s=>Wn(s)).join(",")),e.Te=t}return e.Te}function ja(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!Kg(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!kd(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!Au(n.startAt,e.startAt)&&Au(n.endAt,e.endAt)}function sa(n){return M.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $a(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ei(e)?"-0":e}}function qd(n){return{integerValue:""+n}}function fy(n,e){return Ug(e)?qd(e):$a(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const by=new Ut([4294967295,4294967295],0);function ku(n){const e=Sy().encode(n),t=new ld;return t.update(e),new Uint8Array(t.digest())}function Du(n){const e=new DataView(n.buffer),t=e.getUint32(0,!0),s=e.getUint32(4,!0),r=e.getUint32(8,!0),i=e.getUint32(12,!0);return[new Ut([t,s],0),new Ut([r,i],0)]}class za{constructor(e,t,s){if(this.bitmap=e,this.padding=t,this.hashCount=s,t<0||t>=8)throw new Ds(`Invalid padding: ${t}`);if(s<0)throw new Ds(`Invalid hash count: ${s}`);if(e.length>0&&this.hashCount===0)throw new Ds(`Invalid hash count: ${s}`);if(e.length===0&&t!==0)throw new Ds(`Invalid padding when bitmap length is 0: ${t}`);this.ge=8*e.length-t,this.pe=Ut.fromNumber(this.ge)}ye(e,t,s){let r=e.add(t.multiply(Ut.fromNumber(s)));return r.compare(by)===1&&(r=new Ut([r.getBits(0),r.getBits(1)],0)),r.modulo(this.pe).toNumber()}we(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(this.ge===0)return!1;const t=ku(e),[s,r]=Du(t);for(let i=0;i<this.hashCount;i++){const a=this.ye(s,r,i);if(!this.we(a))return!1}return!0}static create(e,t,s){const r=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),a=new za(i,r,t);return s.forEach(l=>a.insert(l)),a}insert(e){if(this.ge===0)return;const t=ku(e),[s,r]=Du(t);for(let i=0;i<this.hashCount;i++){const a=this.ye(s,r,i);this.Se(a)}}Se(e){const t=Math.floor(e/8),s=e%8;this.bitmap[t]|=1<<s}}class Ds extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gy{constructor(e){this.yt=e}}function Ky(n){const e=qy({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?si(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ui(n){return new Vy(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mn="RemoteStore";class xE{constructor(e,t,s,r,i){this.localStore=e,this.datastore=t,this.asyncQueue=s,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=i,this.Aa.Oo(a=>{s.enqueueAndForget(async()=>{wn(this)&&(x(mn,"Restarting streams for network reachability change."),await async function(u){const h=q(u);h.Ea.add(4),await ar(h),h.Ra.set("Unknown"),h.Ea.delete(4),await Bi(h)}(this))})}),this.Ra=new OE(s,r)}}async function Bi(n){if(wn(n))for(const e of n.da)await e(!0)}async function ar(n){for(const e of n.da)await e(!1)}function df(n,e){const t=q(n);t.Ia.has(e.targetId)||(t.Ia.set(e.targetId,e),el(t)?Za(t):ns(t).O_()&&Ja(t,e))}function Xa(n,e){const t=q(n),s=ns(t);t.Ia.delete(e),s.O_()&&ff(t,e),t.Ia.size===0&&(s.O_()?s.L_():wn(t)&&t.Ra.set("Unknown"))}function Ja(n,e){if(n.Va.Ue(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(j.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}ns(n).Y_(e)}function ff(n,e){n.Va.Ue(e),ns(n).Z_(e)}function Za(n){n.Va=new Py({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),At:e=>n.Ia.get(e)||null,ht:()=>n.datastore.serializer.databaseId}),ns(n).start(),n.Ra.ua()}function el(n){return wn(n)&&!ns(n).x_()&&n.Ia.size>0}function wn(n){return q(n).Ea.size===0}function pf(n){n.Va=void 0}async function ME(n){n.Ra.set("Online")}async function LE(n){n.Ia.forEach((e,t)=>{Ja(n,e)})}async function FE(n,e){pf(n),el(n)?(n.Ra.ha(e),Za(n)):n.Ra.set("Unknown")}async function UE(n,e,t){if(n.Ra.set("Online"),e instanceof Yd&&e.state===2&&e.cause)try{await async function(r,i){const a=i.cause;for(const l of i.targetIds)r.Ia.has(l)&&(await r.remoteSyncer.rejectListen(l,a),r.Ia.delete(l),r.Va.removeTarget(l))}(n,e)}catch(s){x(mn,"Failed to remove targets %s: %s ",e.targetIds.join(","),s),await ai(n,s)}else if(e instanceof Kr?n.Va.Ze(e):e instanceof Qd?n.Va.st(e):n.Va.tt(e),!t.isEqual(j.min()))try{const s=await cf(n.localStore);t.compareTo(s)>=0&&await function(i,a){const l=i.Va.Tt(a);return l.targetChanges.forEach((u,h)=>{if(u.resumeToken.approximateByteSize()>0){const f=i.Ia.get(h);f&&i.Ia.set(h,f.withResumeToken(u.resumeToken,a))}}),l.targetMismatches.forEach((u,h)=>{const f=i.Ia.get(u);if(!f)return;i.Ia.set(u,f.withResumeToken(Ne.EMPTY_BYTE_STRING,f.snapshotVersion)),ff(i,u);const p=new Lt(f.target,u,h,f.sequenceNumber);Ja(i,p)}),i.remoteSyncer.applyRemoteEvent(l)}(n,t)}catch(s){x(mn,"Failed to raise snapshot:",s),await ai(n,s)}}async function ai(n,e,t){if(!es(e))throw e;n.Ea.add(1),await ar(n),n.Ra.set("Offline"),t||(t=()=>cf(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{x(mn,"Retrying IndexedDB access"),await t(),n.Ea.delete(1),await Bi(n)})}function _f(n,e){return e().catch(t=>ai(n,t,e))}async function qi(n){const e=q(n),t=Kt(e);let s=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:Fa;for(;BE(e);)try{const r=await vE(e.localStore,s);if(r===null){e.Ta.length===0&&t.L_();break}s=r.batchId,qE(e,r)}catch(r){await ai(e,r)}mf(e)&&gf(e)}function BE(n){return wn(n)&&n.Ta.length<10}function qE(n,e){n.Ta.push(e);const t=Kt(n);t.O_()&&t.X_&&t.ea(e.mutations)}function mf(n){return wn(n)&&!Kt(n).x_()&&n.Ta.length>0}function gf(n){Kt(n).start()}async function jE(n){Kt(n).ra()}async function $E(n){const e=Kt(n);for(const t of n.Ta)e.ea(t.mutations)}async function WE(n,e,t){const s=n.Ta.shift(),r=Wa.from(s,e,t);await _f(n,()=>n.remoteSyncer.applySuccessfulWrite(r)),await qi(n)}async function zE(n,e){e&&Kt(n).X_&&await async function(s,r){if(function(a){return Cy(a)&&a!==b.ABORTED}(r.code)){const i=s.Ta.shift();Kt(s).B_(),await _f(s,()=>s.remoteSyncer.rejectFailedWrite(i.batchId,r)),await qi(s)}}(n,e),mf(n)&&gf(n)}async function Wu(n,e){const t=q(n);t.asyncQueue.verifyOperationInProgress(),x(mn,"RemoteStore received new credentials");const s=wn(t);t.Ea.add(3),await ar(t),s&&t.Ra.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ea.delete(3),await Bi(t)}async function HE(n,e){const t=q(n);e?(t.Ea.delete(2),await Bi(t)):e||(t.Ea.add(2),await ar(t),t.Ra.set("Unknown"))}function ns(n){return n.ma||(n.ma=function(t,s,r){const i=q(t);return i.sa(),new NE(s,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,r)}(n.datastore,n.asyncQueue,{Xo:ME.bind(null,n),t_:LE.bind(null,n),r_:FE.bind(null,n),H_:UE.bind(null,n)}),n.da.push(async e=>{e?(n.ma.B_(),el(n)?Za(n):n.Ra.set("Unknown")):(await n.ma.stop(),pf(n))})),n.ma}function Kt(n){return n.fa||(n.fa=function(t,s,r){const i=q(t);return i.sa(),new kE(s,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,r)}(n.datastore,n.asyncQueue,{Xo:()=>Promise.resolve(),t_:jE.bind(null,n),r_:zE.bind(null,n),ta:$E.bind(null,n),na:WE.bind(null,n)}),n.da.push(async e=>{e?(n.fa.B_(),await qi(n)):(await n.fa.stop(),n.Ta.length>0&&(x(mn,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))})),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qt="FirestoreClient";class _T{constructor(e,t,s,r,i){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=s,this.databaseInfo=r,this.user=Me.UNAUTHENTICATED,this.clientId=La.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=i,this.authCredentials.start(s,async a=>{x(Qt,"Received user=",a.uid),await this.authCredentialListener(a),this.user=a}),this.appCheckCredentials.start(s,a=>(x(Qt,"Received new app check token=",a),this.appCheckCredentialListener(a,this.user)))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();const e=new ht;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(t){const s=nl(t,"Failed to shutdown persistence");e.reject(s)}}),e.promise}}async function Vo(n,e){n.asyncQueue.verifyOperationInProgress(),x(Qt,"Initializing OfflineComponentProvider");const t=n.configuration;await e.initialize(t);let s=t.initialUser;n.setCredentialChangeListener(async r=>{s.isEqual(r)||(await lf(e.localStore,r),s=r)}),e.persistence.setDatabaseDeletedListener(()=>n.terminate()),n._offlineComponents=e}async function Yu(n,e){n.asyncQueue.verifyOperationInProgress();const t=await mT(n);x(Qt,"Initializing OnlineComponentProvider"),await e.initialize(t,n.configuration),n.setCredentialChangeListener(s=>Wu(e.remoteStore,s)),n.setAppCheckTokenChangeListener((s,r)=>Wu(e.remoteStore,r)),n._onlineComponents=e}async function mT(n){if(!n._offlineComponents)if(n._uninitializedComponentsProvider){x(Qt,"Using user provided OfflineComponentProvider");try{await Vo(n,n._uninitializedComponentsProvider._offline)}catch(e){const t=e;if(!function(r){return r.name==="FirebaseError"?r.code===b.FAILED_PRECONDITION||r.code===b.UNIMPLEMENTED:!(typeof DOMException<"u"&&r instanceof DOMException)||r.code===22||r.code===20||r.code===11}(t))throw t;qn("Error using user provided cache. Falling back to memory cache: "+t),await Vo(n,new li)}}else x(Qt,"Using default OfflineComponentProvider"),await Vo(n,new pT(void 0));return n._offlineComponents}async function ul(n){return n._onlineComponents||(n._uninitializedComponentsProvider?(x(Qt,"Using user provided OnlineComponentProvider"),await Yu(n,n._uninitializedComponentsProvider._online)):(x(Qt,"Using default OnlineComponentProvider"),await Yu(n,new fa))),n._onlineComponents}function gT(n){return ul(n).then(e=>e.syncEngine)}function yT(n){return ul(n).then(e=>e.datastore)}async function ci(n){const e=await ul(n),t=e.eventManager;return t.onListen=tT.bind(null,e.syncEngine),t.onUnlisten=rT.bind(null,e.syncEngine),t.onFirstRemoteStoreListen=nT.bind(null,e.syncEngine),t.onLastRemoteStoreUnlisten=iT.bind(null,e.syncEngine),t}function ET(n,e,t={}){const s=new ht;return n.asyncQueue.enqueueAndForget(async()=>function(i,a,l,u,h){const f=new cl({next:m=>{f.Nu(),a.enqueueAndForget(()=>rl(i,p));const I=m.docs.has(l);!I&&m.fromCache?h.reject(new O(b.UNAVAILABLE,"Failed to get document because the client is offline.")):I&&m.fromCache&&u&&u.source==="server"?h.reject(new O(b.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):h.resolve(m)},error:m=>h.reject(m)}),p=new ol(Di(l.path),f,{includeMetadataChanges:!0,qa:!0});return sl(i,p)}(await ci(n),n.asyncQueue,e,t,s)),s.promise}function TT(n,e,t={}){const s=new ht;return n.asyncQueue.enqueueAndForget(async()=>function(i,a,l,u,h){const f=new cl({next:m=>{f.Nu(),a.enqueueAndForget(()=>rl(i,p)),m.fromCache&&u.source==="server"?h.reject(new O(b.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):h.resolve(m)},error:m=>h.reject(m)}),p=new ol(l,f,{includeMetadataChanges:!0,qa:!0});return sl(i,p)}(await ci(n),n.asyncQueue,e,t,s)),s.promise}function vT(n,e,t){const s=new ht;return n.asyncQueue.enqueueAndForget(async()=>{try{const r=await yT(n);s.resolve(async function(a,l,u){var k;const h=q(a),{request:f,gt:p,parent:m}=By(h.serializer,iy(l),u);h.connection.$o||delete f.parent;const I=(await h.Ho("RunAggregationQuery",h.serializer.databaseId,m,f,1)).filter(N=>!!N.result);J(I.length===1,64727);const C=(k=I[0].result)==null?void 0:k.aggregateFields;return Object.keys(C).reduce((N,B)=>(N[p[B]]=C[B],N),{})}(r,e,t))}catch(r){s.reject(r)}}),s.promise}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt{constructor(e,t,s){this.converter=t,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new Nt(this.firestore,e,this._query)}}class ue{constructor(e,t,s){this.converter=t,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new qt(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new ue(this.firestore,e,this._key)}toJSON(){return{type:ue._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,t,s){if(rr(t,ue._jsonSchema))return new ue(e,s||null,new M(re.fromString(t.referencePath)))}}ue._jsonSchemaVersion="firestore/documentReference/1.0",ue._jsonSchema={type:Ee("string",ue._jsonSchemaVersion),referencePath:Ee("string")};class qt extends Nt{constructor(e,t,s){super(e,t,Di(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new ue(this.firestore,null,new M(e))}withConverter(e){return new qt(this.firestore,e,this._path)}}function pR(n,e,...t){if(n=le(n),md("collection","path",e),n instanceof ji){const s=re.fromString(e,...t);return du(s),new qt(n,null,s)}{if(!(n instanceof ue||n instanceof qt))throw new O(b.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=n._path.child(re.fromString(e,...t));return du(s),new qt(n.firestore,null,s)}}function IT(n,e,...t){if(n=le(n),arguments.length===1&&(e=La.newId()),md("doc","path",e),n instanceof ji){const s=re.fromString(e,...t);return hu(s),new ue(n,null,new M(s))}{if(!(n instanceof ue||n instanceof qt))throw new O(b.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=n._path.child(re.fromString(e,...t));return hu(s),new ue(n.firestore,n instanceof qt?n.converter:null,new M(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rs{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new O(b.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new be(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}function _R(){return new rs(Xo)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function TR(n){n=Fe(n,ue);const e=Fe(n.firestore,at);return ET(ss(e),n._key).then(t=>Ff(e,n,t))}dn._jsonSchemaVersion="firestore/querySnapshot/1.0",dn._jsonSchema={type:Ee("string",dn._jsonSchemaVersion),bundleSource:Ee("string","QuerySnapshot"),bundleName:Ee("string"),bundle:Ee("string")};class Gi extends OT{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ze(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ue(this.firestore,null,t)}}function vR(n){n=Fe(n,Nt);const e=Fe(n.firestore,at),t=ss(e),s=new Gi(e);return Mf(n._query),TT(t,n._query).then(r=>new dn(e,s,n,r))}function wR(n,e,t){n=Fe(n,ue);const s=Fe(n.firestore,at),r=vl(n.converter,e,t);return hr(s,[dl(cr(s),"setDoc",n._key,r,n.converter!==null,t).toMutation(n._key,je.none())])}function IR(n,e,t,...s){n=Fe(n,ue);const r=Fe(n.firestore,at),i=cr(r);let a;return a=typeof(e=le(e))=="string"||e instanceof rs?kf(i,"updateDoc",n._key,e,t,s):Nf(i,"updateDoc",n._key,e),hr(r,[a.toMutation(n._key,je.exists(!0))])}function AR(n){return hr(Fe(n.firestore,at),[new Li(n._key,je.none())])}function RR(n,e){const t=Fe(n.firestore,at),s=IT(n),r=vl(n.converter,e);return hr(t,[dl(cr(n.firestore),"addDoc",s._key,r,n.converter!==null,{}).toMutation(s._key,je.exists(!1))]).then(()=>s)}function CR(n,...e){var u,h,f;n=le(n);let t={includeMetadataChanges:!1,source:"default"},s=0;typeof e[s]!="object"||sh(e[s])||(t=e[s++]);const r={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(sh(e[s])){const p=e[s];e[s]=(u=p.next)==null?void 0:u.bind(p),e[s+1]=(h=p.error)==null?void 0:h.bind(p),e[s+2]=(f=p.complete)==null?void 0:f.bind(p)}let i,a,l;if(n instanceof ue)a=Fe(n.firestore,at),l=Di(n._key.path),i={next:p=>{e[s]&&e[s](Ff(a,n,p))},error:e[s+1],complete:e[s+2]};else{const p=Fe(n,Nt);a=Fe(p.firestore,at),l=p._query;const m=new Gi(a);i={next:I=>{e[s]&&e[s](new dn(a,m,p,I))},error:e[s+1],complete:e[s+2]},Mf(n._query)}return function(m,I,C,k){const N=new cl(k),B=new ol(I,N,C);return m.asyncQueue.enqueueAndForget(async()=>sl(await ci(m),B)),()=>{N.Nu(),m.asyncQueue.enqueueAndForget(async()=>rl(await ci(m),B))}}(ss(a),l,r,i)}function hr(n,e){return function(s,r){const i=new ht;return s.asyncQueue.enqueueAndForget(async()=>oT(await gT(s),r,i)),i.promise}(ss(n),e)}function Ff(n,e,t){const s=t.docs.get(e._key),r=new Gi(n);return new hn(n,r,e._key,s,new Vs(t.hasPendingWrites,t.fromCache),e.converter)}function SR(n){return LT(n,{count:xT()})}function LT(n,e){const t=Fe(n.firestore,at),s=ss(t),r=jg(e,(i,a)=>new Ay(a,i.aggregateType,i._internalFieldPath));return vT(s,n._query,r).then(i=>function(l,u,h){const f=new Gi(l);return new ST(u,f,h)}(t,n,i))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uf="firebasestorage.googleapis.com",Bf="storageBucket",UT=2*60*1e3,BT=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ct={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class Mo{constructor(e,t){this.data=e,this.contentType=t||null}}function gv(n,e){switch(n){case ct.RAW:return new Mo($f(e));case ct.BASE64:case ct.BASE64URL:return new Mo(Wf(n,e));case ct.DATA_URL:return new Mo(Ev(e),Tv(e))}throw wl()}function $f(n){const e=[];for(let t=0;t<n.length;t++){let s=n.charCodeAt(t);if(s<=127)e.push(s);else if(s<=2047)e.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(t<n.length-1&&(n.charCodeAt(t+1)&64512)===56320))e.push(239,191,189);else{const i=s,a=n.charCodeAt(++t);s=65536|(i&1023)<<10|a&1023,e.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?e.push(239,191,189):e.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(e)}function yv(n){let e;try{e=decodeURIComponent(n)}catch{throw Us(ct.DATA_URL,"Malformed data URL.")}return $f(e)}function Wf(n,e){switch(n){case ct.BASE64:{const r=e.indexOf("-")!==-1,i=e.indexOf("_")!==-1;if(r||i)throw Us(n,"Invalid character '"+(r?"-":"_")+"' found: is it base64url encoded?");break}case ct.BASE64URL:{const r=e.indexOf("+")!==-1,i=e.indexOf("/")!==-1;if(r||i)throw Us(n,"Invalid character '"+(r?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let t;try{t=mv(e)}catch(r){throw r.message.includes("polyfill")?r:Us(n,"Invalid character found")}const s=new Uint8Array(t.length);for(let r=0;r<t.length;r++)s[r]=t.charCodeAt(r);return s}class zf{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(t===null)throw Us(ct.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=t[1]||null;s!=null&&(this.base64=vv(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=e.substring(e.indexOf(",")+1)}}function Ev(n){const e=new zf(n);return e.base64?Wf(ct.BASE64,e.rest):yv(e.rest)}function Tv(n){return new zf(n).contentType}function vv(n,e){return n.length>=e.length?n.substring(n.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mt{constructor(e,t){let s=0,r="";oh(e)?(this.data_=e,s=e.size,r=e.type):e instanceof ArrayBuffer?(t?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),s=this.data_.length):e instanceof Uint8Array&&(t?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),s=e.length),this.size_=s,this.type_=r}size(){return this.size_}type(){return this.type_}slice(e,t){if(oh(this.data_)){const s=this.data_,r=_v(s,e,t);return r===null?null:new Mt(r)}else{const s=new Uint8Array(this.data_.buffer,e,t-e);return new Mt(s,!0)}}static getBlob(...e){if(Al()){const t=e.map(s=>s instanceof Mt?s.data_:s);return new Mt(pv.apply(null,t))}else{const t=e.map(a=>Il(a)?gv(ct.RAW,a).data:a.data_);let s=0;t.forEach(a=>{s+=a.byteLength});const r=new Uint8Array(s);let i=0;return t.forEach(a=>{for(let l=0;l<a.length;l++)r[i++]=a[l]}),new Mt(r,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hf(n){let e;try{e=JSON.parse(n)}catch{return null}return iv(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wv(n){if(n.length===0)return null;const e=n.lastIndexOf("/");return e===-1?"":n.slice(0,e)}function Iv(n,e){const t=e.split("/").filter(s=>s.length>0).join("/");return n.length===0?t:n+"/"+t}function Gf(n){const e=n.lastIndexOf("/",n.length-2);return e===-1?n:n.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Av(n,e){return e}class qe{constructor(e,t,s,r){this.server=e,this.local=t||e,this.writable=!!s,this.xform=r||Av}}let qr=null;function Rv(n){return!Il(n)||n.length<2?n:Gf(n)}function Kf(){if(qr)return qr;const n=[];n.push(new qe("bucket")),n.push(new qe("generation")),n.push(new qe("metageneration")),n.push(new qe("name","fullPath",!0));function e(i,a){return Rv(a)}const t=new qe("name");t.xform=e,n.push(t);function s(i,a){return a!==void 0?Number(a):a}const r=new qe("size");return r.xform=s,n.push(r),n.push(new qe("timeCreated")),n.push(new qe("updated")),n.push(new qe("md5Hash",null,!0)),n.push(new qe("cacheControl",null,!0)),n.push(new qe("contentDisposition",null,!0)),n.push(new qe("contentEncoding",null,!0)),n.push(new qe("contentLanguage",null,!0)),n.push(new qe("contentType",null,!0)),n.push(new qe("metadata","customMetadata",!0)),qr=n,qr}function Cv(n,e){function t(){const s=n.bucket,r=n.fullPath,i=new Je(s,r);return e._makeStorageReference(i)}Object.defineProperty(n,"ref",{get:t})}function Sv(n,e,t){const s={};s.type="file";const r=t.length;for(let i=0;i<r;i++){const a=t[i];s[a.local]=a.xform(s,e[a.server])}return Cv(s,n),s}function Qf(n,e,t){const s=Hf(e);return s===null?null:Sv(n,s,t)}function bv(n,e,t,s){const r=Hf(e);if(r===null||!Il(r.downloadTokens))return null;const i=r.downloadTokens;if(i.length===0)return null;const a=encodeURIComponent;return i.split(",").map(h=>{const f=n.bucket,p=n.fullPath,m="/b/"+a(f)+"/o/"+a(p),I=Rl(m,t,s),C=jf({alt:"media",token:h});return I+C})[0]}function Pv(n,e){const t={},s=e.length;for(let r=0;r<s;r++){const i=e[r];i.writable&&(t[i.server]=n[i.local])}return JSON.stringify(t)}class Yf{constructor(e,t,s,r){this.url=e,this.method=t,this.handler=s,this.timeout=r,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xf(n){if(!n)throw wl()}function Nv(n,e){function t(s,r){const i=Qf(n,r,e);return Xf(i!==null),i}return t}function kv(n,e){function t(s,r){const i=Qf(n,r,e);return Xf(i!==null),bv(i,r,n.host,n._protocol)}return t}function Jf(n){function e(t,s){let r;return t.getStatus()===401?t.getErrorText().includes("Firebase App Check token is invalid")?r=WT():r=$T():t.getStatus()===402?r=jT(n.bucket):t.getStatus()===403?r=zT(n.path):r=s,r.status=t.getStatus(),r.serverResponse=s.serverResponse,r}return e}function Dv(n){const e=Jf(n);function t(s,r){let i=e(s,r);return s.getStatus()===404&&(i=qT(n.path)),i.serverResponse=r.serverResponse,i}return t}function Vv(n,e,t){const s=e.fullServerUrl(),r=Rl(s,n.host,n._protocol),i="GET",a=n.maxOperationRetryTime,l=new Yf(r,i,kv(n,t),a);return l.errorHandler=Dv(e),l}function Ov(n,e){return n&&n.contentType||e&&e.type()||"application/octet-stream"}function xv(n,e,t){const s=Object.assign({},t);return s.fullPath=n.path,s.size=e.size(),s.contentType||(s.contentType=Ov(null,e)),s}function Mv(n,e,t,s,r){const i=e.bucketOnlyServerUrl(),a={"X-Goog-Upload-Protocol":"multipart"};function l(){let U="";for(let $=0;$<2;$++)U=U+Math.random().toString().slice(2);return U}const u=l();a["Content-Type"]="multipart/related; boundary="+u;const h=xv(e,s,r),f=Pv(h,t),p="--"+u+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gn{constructor(e,t){this._service=e,t instanceof Je?this._location=t:this._location=Je.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new gn(e,t)}get root(){const e=new Je(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Gf(this._location.path)}get storage(){return this._service}get parent(){const e=wv(this._location.path);if(e===null)return null;const t=new Je(this._location.bucket,e);return new gn(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw ev(e)}}function Uv(n,e,t){n._throwIfRoot("uploadBytes");const s=Mv(n.storage,n._location,Kf(),new Mt(e,!0),t);return n.storage.makeRequestWithTokens(s,Zf).then(r=>({metadata:r,ref:n}))}function Bv(n){n._throwIfRoot("getDownloadURL");const e=Vv(n.storage,n._location,Kf());return n.storage.makeRequestWithTokens(e,Zf).then(t=>{if(t===null)throw JT();return t})}function qv(n,e){const t=Iv(n._location.path,e),s=new Je(n._location.bucket,t);return new gn(n.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tp="storage";function NR(n,e,t){return n=le(n),Uv(n,e,t)}function kR(n){return n=le(n),Bv(n)}function DR(n,e){return n=le(n),Wv(n,e)}function Hv(n=Si(),e){n=le(n);const s=Ri(n,tp).getImmediate({identifier:e}),r=vi("storage");return r&&Gv(s,...r),s}function Gv(n,e,t,s={}){zv(n,e,t,s)}function Kv(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),s=n.getProvider("auth-internal"),r=n.getProvider("app-check-internal");return new Cl(t,s,r,e,xa)}function Qv(){pn(new $t(tp,Kv,"PUBLIC").setMultipleInstances(!0)),nt(ch,uh,""),nt(ch,uh,"esm2020")}Qv();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hh={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class He extends Jt{constructor(e,t,s){super(`${Sl}/${e}`,t||""),this.details=s,Object.setPrototypeOf(this,He.prototype)}}function Jv(n){if(n>=200&&n<300)return"ok";switch(n){case 0:return"internal";case 400:return"invalid-argument";case 401:return"unauthenticated";case 403:return"permission-denied";case 404:return"not-found";case 409:return"aborted";case 429:return"resource-exhausted";case 499:return"cancelled";case 500:return"internal";case 501:return"unimplemented";case 503:return"unavailable";case 504:return"deadline-exceeded"}return"unknown"}function di(n,e){let t=Jv(n),s=t,r;try{const i=e&&e.error;if(i){const a=i.status;if(typeof a=="string"){if(!hh[a])return new He("internal","internal");t=hh[a],s=a}const l=i.message;typeof l=="string"&&(s=l),r=i.details,r!==void 0&&(r=Gn(r))}}catch{}return t==="ok"?null:new He(t,s,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zv{constructor(e,t,s,r){this.app=e,this.auth=null,this.messaging=null,this.appCheck=null,this.serverAppAppCheckToken=null,Ci(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.auth=t.getImmediate({optional:!0}),this.messaging=s.getImmediate({optional:!0}),this.auth||t.get().then(i=>this.auth=i,()=>{}),this.messaging||s.get().then(i=>this.messaging=i,()=>{}),this.appCheck||r==null||r.get().then(i=>this.appCheck=i,()=>{})}async getAuthToken(){if(this.auth)try{const e=await this.auth.getToken();return e==null?void 0:e.accessToken}catch{return}}async getMessagingToken(){if(!(!this.messaging||!("Notification"in self)||Notification.permission!=="granted"))try{return await this.messaging.getToken()}catch{return}}async getAppCheckToken(e){if(this.serverAppAppCheckToken)return this.serverAppAppCheckToken;if(this.appCheck){const t=e?await this.appCheck.getLimitedUseToken():await this.appCheck.getToken();return t.error?null:t.token}return null}async getContext(e){const t=await this.getAuthToken(),s=await this.getMessagingToken(),r=await this.getAppCheckToken(e);return{authToken:t,messagingToken:s,appCheckToken:r}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ma="us-central1",ew=/^data: (.*?)(?:\n|$)/;function tw(n){let e=null;return{promise:new Promise((t,s)=>{e=setTimeout(()=>{s(new He("deadline-exceeded","deadline-exceeded"))},n)}),cancel:()=>{e&&clearTimeout(e)}}}class nw{constructor(e,t,s,r,i=ma,a=(...l)=>fetch(...l)){this.app=e,this.fetchImpl=a,this.emulatorOrigin=null,this.contextProvider=new Zv(e,t,s,r),this.cancelAllRequests=new Promise(l=>{this.deleteService=()=>Promise.resolve(l())});try{const l=new URL(i);this.customDomain=l.origin+(l.pathname==="/"?"":l.pathname),this.region=ma}catch{this.customDomain=null,this.region=i}}_delete(){return this.deleteService()}_url(e){const t=this.app.options.projectId;return this.emulatorOrigin!==null?`${this.emulatorOrigin}/${t}/${this.region}/${e}`:this.customDomain!==null?`${this.customDomain}/${e}`:`https://${this.region}-${t}.cloudfunctions.net/${e}`}}function sw(n,e,t){const s=Xt(e);n.emulatorOrigin=`http${s?"s":""}://${e}:${t}`,s&&(wi(n.emulatorOrigin),Ii("Functions",!0))}function rw(n,e,t){const s=r=>ow(n,e,r,{});return s.stream=(r,i)=>lw(n,e,r,i),s}async function iw(n,e,t,s){t["Content-Type"]="application/json";let r;try{r=await s(n,{method:"POST",body:JSON.stringify(e),headers:t})}catch{return{status:0,json:null}}let i=null;try{i=await r.json()}catch{}return{status:r.status,json:i}}async function sp(n,e){const t={},s=await n.contextProvider.getContext(e.limitedUseAppCheckTokens);return s.authToken&&(t.Authorization="Bearer "+s.authToken),s.messagingToken&&(t["Firebase-Instance-ID-Token"]=s.messagingToken),s.appCheckToken!==null&&(t["X-Firebase-AppCheck"]=s.appCheckToken),t}function ow(n,e,t,s){const r=n._url(e);return aw(n,r,t,s)}async function aw(n,e,t,s){t=hi(t);const r={data:t},i=await sp(n,s),a=s.timeout||7e4,l=tw(a),u=await Promise.race([iw(e,r,i,n.fetchImpl),l.promise,n.cancelAllRequests]);if(l.cancel(),!u)throw new He("cancelled","Firebase Functions instance was deleted.");const h=di(u.status,u.json);if(h)throw h;if(!u.json)throw new He("internal","Response is not valid JSON object.");let f=u.json.data;if(typeof f>"u"&&(f=u.json.result),typeof f>"u")throw new He("internal","Response is missing data field.");return{data:Gn(f)}}function lw(n,e,t,s){const r=n._url(e);return cw(n,r,t,s||{})}async function cw(n,e,t,s){var m;t=hi(t);const r={data:t},i=await sp(n,s);i["Content-Type"]="application/json",i.Accept="text/event-stream";let a;try{a=await n.fetchImpl(e,{method:"POST",body:JSON.stringify(r),headers:i,signal:s==null?void 0:s.signal})}catch(I){if(I instanceof Error&&I.name==="AbortError"){const k=new He("cancelled","Request was cancelled.");return{data:Promise.reject(k),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(k)}}}}}}const C=di(0,null);return{data:Promise.reject(C),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(C)}}}}}}let l,u;const h=new Promise((I,C)=>{l=I,u=C});(m=s==null?void 0:s.signal)==null||m.addEventListener("abort",()=>{const I=new He("cancelled","Request was cancelled.");u(I)});const f=a.body.getReader(),p=uw(f,l,u,s==null?void 0:s.signal);return{stream:{[Symbol.asyncIterator](){const I=p.getReader();return{async next(){const{value:C,done:k}=await I.read();return{value:C,done:k}},async return(){return await I.cancel(),{done:!0,value:void 0}}}}},data:h}}function uw(n,e,t,s){const r=(a,l)=>{const u=a.match(ew);if(!u)return;const h=u[1];try{const f=JSON.parse(h);if("result"in f){e(Gn(f.result));return}if("message"in f){l.enqueue(Gn(f.message));return}if("error"in f){const p=di(0,f);l.error(p),t(p);return}}catch(f){if(f instanceof He){l.error(f),t(f);return}}},i=new TextDecoder;return new ReadableStream({start(a){let l="";return u();async function u(){if(s!=null&&s.aborted){const h=new He("cancelled","Request was cancelled");return a.error(h),t(h),Promise.resolve()}try{const{value:h,done:f}=await n.read();if(f){l.trim()&&r(l.trim(),a),a.close();return}if(s!=null&&s.aborted){const m=new He("cancelled","Request was cancelled");a.error(m),t(m),await n.cancel();return}l+=i.decode(h,{stream:!0});const p=l.split(`
`);l=p.pop()||"";for(const m of p)m.trim()&&r(m.trim(),a);return u()}catch(h){const f=h instanceof He?h:di(0,null);a.error(f),t(f)}}},cancel(){return n.cancel()}})}const dh="@firebase/functions",fh="0.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hw="auth-internal",dw="app-check-internal",fw="messaging-internal";function pw(n){const e=(t,{instanceIdentifier:s})=>{const r=t.getProvider("app").getImmediate(),i=t.getProvider(hw),a=t.getProvider(fw),l=t.getProvider(dw);return new nw(r,i,a,l,s)};pn(new $t(Sl,e,"PUBLIC").setMultipleInstances(!0)),nt(dh,fh,n),nt(dh,fh,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _w(n=Si(),e=ma){const s=Ri(le(n),Sl).getImmediate({identifier:e}),r=vi("functions");return r&&mw(s,...r),s}function mw(n,e,t){sw(le(n),e,t)}function VR(n,e,t){return rw(le(n),e)}pw();var ph={};const _h="@firebase/database",mh="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ew{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return gt(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ip=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new yw(e)}}catch{}return new Ew},cn=ip("localStorage"),Tw=ip("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ln=new Oa("@firebase/database"),vw=function(){let n=1;return function(){return n++}}(),op=function(n){const e=wm(n),t=new vm;t.update(e);const s=t.digest();return ka.encodeByteArray(s)},dr=function(...n){let e="";for(let t=0;t<n.length;t++){const s=n[t];Array.isArray(s)||s&&typeof s=="object"&&typeof s.length=="number"?e+=dr.apply(null,s):typeof s=="object"?e+=Se(s):e+=s,e+=" "}return e};let Bs=null,gh=!0;const ww=function(n,e){V(!0,"Can't turn on custom loggers persistently."),Ln.logLevel=K.VERBOSE,Bs=Ln.log.bind(Ln)},Ce=function(...n){if(gh===!0&&(gh=!1,Bs===null&&Tw.get("logging_enabled")===!0&&ww()),Bs){const e=dr.apply(null,n);Bs(e)}},fr=function(n){return function(...e){Ce(n,...e)}},ga=function(...n){const e="FIREBASE INTERNAL ERROR: "+dr(...n);Ln.error(e)},bt=function(...n){const e=`FIREBASE FATAL ERROR: ${dr(...n)}`;throw Ln.error(e),new Error(e)},Ke=function(...n){const e="FIREBASE WARNING: "+dr(...n);Ln.warn(e)},Iw=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&Ke("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},Ki=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},Aw=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},Kn="[MIN_NAME]",yn="[MAX_NAME]",In=function(n,e){if(n===e)return 0;if(n===Kn||e===yn)return-1;if(e===Kn||n===yn)return 1;{const t=yh(n),s=yh(e);return t!==null?s!==null?t-s===0?n.length-e.length:t-s:-1:s!==null?1:n<e?-1:1}},Rw=function(n,e){return n===e?0:n<e?-1:1},Cs=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+Se(e))},bl=function(n){if(typeof n!="object"||n===null)return Se(n);const e=[];for(const s in n)e.push(s);e.sort();let t="{";for(let s=0;s<e.length;s++)s!==0&&(t+=","),t+=Se(e[s]),t+=":",t+=bl(n[e[s]]);return t+="}",t},ap=function(n,e){const t=n.length;if(t<=e)return[n];const s=[];for(let r=0;r<t;r+=e)r+e>t?s.push(n.substring(r,t)):s.push(n.substring(r,r+e));return s};function Qe(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const lp=function(n){V(!Ki(n),"Invalid JSON number");const e=11,t=52,s=(1<<e-1)-1;let r,i,a,l,u;n===0?(i=0,a=0,r=1/n===-1/0?1:0):(r=n<0,n=Math.abs(n),n>=Math.pow(2,1-s)?(l=Math.min(Math.floor(Math.log(n)/Math.LN2),s),i=l+s,a=Math.round(n*Math.pow(2,t-l)-Math.pow(2,t))):(i=0,a=Math.round(n/Math.pow(2,1-s-t))));const h=[];for(u=t;u;u-=1)h.push(a%2?1:0),a=Math.floor(a/2);for(u=e;u;u-=1)h.push(i%2?1:0),i=Math.floor(i/2);h.push(r?1:0),h.reverse();const f=h.join("");let p="";for(u=0;u<64;u+=8){let m=parseInt(f.substr(u,8),2).toString(16);m.length===1&&(m="0"+m),p=p+m}return p.toLowerCase()},Cw=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},Sw=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"},bw=new RegExp("^-?(0*)\\d{1,10}$"),Pw=-2147483648,Nw=2147483647,yh=function(n){if(bw.test(n)){const e=Number(n);if(e>=Pw&&e<=Nw)return e}return null},is=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw Ke("Exception was thrown by user callback.",t),e},Math.floor(0))}},kw=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},qs=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dw{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,Ci(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(s=>this.appCheck=s)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,s)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)==null||t.get().then(s=>s.addTokenListener(e))}notifyForInvalidToken(){Ke(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vw{constructor(e,t,s){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=s,this.auth_=null,this.auth_=s.getImmediate({optional:!0}),this.auth_||s.onInit(r=>this.auth_=r)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(Ce("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,s)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Ke(e)}}class Yr{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}Yr.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pl="5",cp="v",up="s",hp="r",dp="f",fp=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,pp="ls",_p="p",ya="ac",mp="websocket",gp="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xw{constructor(){this.counters_={}}incrementCounter(e,t=1){gt(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return em(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lo={},Fo={};function Nl(n){const e=n.toString();return Lo[e]||(Lo[e]=new xw),Lo[e]}function Mw(n,e){const t=n.toString();return Fo[t]||(Fo[t]=e()),Fo[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lw{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const s=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let r=0;r<s.length;++r)s[r]&&is(()=>{this.onMessage_(s[r])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eh="start",Fw="close",Uw="pLPCommand",Bw="pRTLPCB",Tp="id",vp="pw",wp="ser",qw="cb",jw="seg",$w="ts",Ww="d",zw="dframe",Ip=1870,Ap=30,Hw=Ip-Ap,Gw=25e3,Kw=3e4;class On{constructor(e,t,s,r,i,a,l){this.connId=e,this.repoInfo=t,this.applicationId=s,this.appCheckToken=r,this.authToken=i,this.transportSessionId=a,this.lastSessionId=l,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=fr(e),this.stats_=Nl(t),this.urlFn=u=>(this.appCheckToken&&(u[ya]=this.appCheckToken),Ep(t,gp,u))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new Lw(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(Kw)),Aw(()=>{if(this.isClosed_)return;this.scriptTagHolder=new kl((...i)=>{const[a,l,u,h,f]=i;if(this.incrementIncomingBytes_(i),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,a===Eh)this.id=l,this.password=u;else if(a===Fw)l?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(l,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+a)},(...i)=>{const[a,l]=i;this.incrementIncomingBytes_(i),this.myPacketOrderer.handleResponse(a,l)},()=>{this.onClosed_()},this.urlFn);const s={};s[Eh]="t",s[wp]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(s[qw]=this.scriptTagHolder.uniqueCallbackIdentifier),s[cp]=Pl,this.transportSessionId&&(s[up]=this.transportSessionId),this.lastSessionId&&(s[pp]=this.lastSessionId),this.applicationId&&(s[_p]=this.applicationId),this.appCheckToken&&(s[ya]=this.appCheckToken),typeof location<"u"&&location.hostname&&fp.test(location.hostname)&&(s[hp]=dp);const r=this.urlFn(s);this.log_("Connecting via long-poll to "+r),this.scriptTagHolder.addTag(r,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){On.forceAllow_=!0}static forceDisallow(){On.forceDisallow_=!0}static isAvailable(){return On.forceAllow_?!0:!On.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!Cw()&&!Sw()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=Se(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const s=Jh(t),r=ap(s,Hw);for(let i=0;i<r.length;i++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,r.length,r[i]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const s={};s[zw]="t",s[Tp]=e,s[vp]=t,this.myDisconnFrame.src=this.urlFn(s),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=Se(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class kl{constructor(e,t,s,r){this.onDisconnect=s,this.urlFn=r,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=vw(),window[Uw+this.uniqueCallbackIdentifier]=e,window[Bw+this.uniqueCallbackIdentifier]=t,this.myIFrame=kl.createIFrame_();let i="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(i='<script>document.domain="'+document.domain+'";<\/script>');const a="<html><body>"+i+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(a),this.myIFrame.doc.close()}catch(l){Ce("frame writing exception"),l.stack&&Ce(l.stack),Ce(l)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||Ce("No IE domain setting required")}catch{const s=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+s+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Tp]=this.myID,e[vp]=this.myPW,e[wp]=this.currentSerial;let t=this.urlFn(e),s="",r=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Ap+s.length<=Ip;){const a=this.pendingSegs.shift();s=s+"&"+jw+r+"="+a.seg+"&"+$w+r+"="+a.ts+"&"+Ww+r+"="+a.d,r++}return t=t+s,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,s){this.pendingSegs.push({seg:e,ts:t,d:s}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const s=()=>{this.outstandingRequests.delete(t),this.newRequest_()},r=setTimeout(s,Math.floor(Gw)),i=()=>{clearTimeout(r),s()};this.addTag(e,i)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const s=this.myIFrame.doc.createElement("script");s.type="text/javascript",s.async=!0,s.src=e,s.onload=s.onreadystatechange=function(){const r=s.readyState;(!r||r==="loaded"||r==="complete")&&(s.onload=s.onreadystatechange=null,s.parentNode&&s.parentNode.removeChild(s),t())},s.onerror=()=>{Ce("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(s)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xw=6e4,Jw=5e3,Zw=10*1024,eI=100*1024,Uo="t",Th="d",tI="s",vh="r",nI="e",wh="o",Ih="a",Ah="n",Rh="p",sI="h";class rI{constructor(e,t,s,r,i,a,l,u,h,f){this.id=e,this.repoInfo_=t,this.applicationId_=s,this.appCheckToken_=r,this.authToken_=i,this.onMessage_=a,this.onReady_=l,this.onDisconnect_=u,this.onKill_=h,this.lastSessionId=f,this.connectionCount=0,this.pendingDataMessages=[],this.state_=0,this.log_=fr("c:"+this.id+":"),this.transportManager_=new tr(t),this.log_("Connection created"),this.start_()}start_(){const e=this.transportManager_.initialTransport();this.conn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,null,this.lastSessionId),this.primaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const t=this.connReceiver_(this.conn_),s=this.disconnReceiver_(this.conn_);this.tx_=this.conn_,this.rx_=this.conn_,this.secondaryConn_=null,this.isHealthy_=!1,setTimeout(()=>{this.conn_&&this.conn_.open(t,s)},Math.floor(0));const r=e.healthyTimeout||0;r>0&&(this.healthyTimeout_=qs(()=>{this.healthyTimeout_=null,this.isHealthy_||(this.conn_&&this.conn_.bytesReceived>eI?(this.log_("Connection exceeded healthy timeout but has received "+this.conn_.bytesReceived+" bytes.  Marking connection healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()):this.conn_&&this.conn_.bytesSent>Zw?this.log_("Connection exceeded healthy timeout but has sent "+this.conn_.bytesSent+" bytes.  Leaving connection alive."):(this.log_("Closing unhealthy connection after timeout."),this.close()))},Math.floor(r)))}nextTransportId_(){return"c:"+this.id+":"+this.connectionCount++}disconnReceiver_(e){return t=>{e===this.conn_?this.onConnectionLost_(t):e===this.secondaryConn_?(this.log_("Secondary connection lost."),this.onSecondaryConnectionLost_()):this.log_("closing an old connection")}}connReceiver_(e){return t=>{this.state_!==2&&(e===this.rx_?this.onPrimaryMessageReceived_(t):e===this.secondaryConn_?this.onSecondaryMessageReceived_(t):this.log_("message on old connection"))}}sendRequest(e){const t={t:"d",d:e};this.sendData_(t)}tryCleanupConnection(){this.tx_===this.secondaryConn_&&this.rx_===this.secondaryConn_&&(this.log_("cleaning up and promoting a connection: "+this.secondaryConn_.connId),this.conn_=this.secondaryConn_,this.secondaryConn_=null)}onSecondaryControl_(e){if(Uo in e){const t=e[Uo];t===Ih?this.upgradeIfSecondaryHealthy_():t===vh?(this.log_("Got a reset on secondary, closing it"),this.secondaryConn_.close(),(this.tx_===this.secondaryConn_||this.rx_===this.secondaryConn_)&&this.close()):t===wh&&(this.log_("got pong on secondary."),this.secondaryResponsesRequired_--,this.upgradeIfSecondaryHealthy_())}}onSecondaryMessageReceived_(e){const t=Cs("t",e),s=Cs("d",e);if(t==="c")this.onSecondaryControl_(s);else if(t==="d")this.pendingDataMessages.push(s);else throw new Error("Unknown protocol layer: "+t)}upgradeIfSecondaryHealthy_(){this.secondaryResponsesRequired_<=0?(this.log_("Secondary connection is healthy."),this.isHealthy_=!0,this.secondaryConn_.markConnectionHealthy(),this.proceedWithUpgrade_()):(this.log_("sending ping on secondary."),this.secondaryConn_.send({t:"c",d:{t:Rh,d:{}}}))}proceedWithUpgrade_(){this.secondaryConn_.start(),this.log_("sending client ack on secondary"),this.secondaryConn_.send({t:"c",d:{t:Ih,d:{}}}),this.log_("Ending transmission on primary"),this.conn_.send({t:"c",d:{t:Ah,d:{}}}),this.tx_=this.secondaryConn_,this.tryCleanupConnection()}onPrimaryMessageReceived_(e){const t=Cs("t",e),s=Cs("d",e);t==="c"?this.onControl_(s):t==="d"&&this.onDataMessage_(s)}onDataMessage_(e){this.onPrimaryResponse_(),this.onMessage_(e)}onPrimaryResponse_(){this.isHealthy_||(this.primaryResponsesRequired_--,this.primaryResponsesRequired_<=0&&(this.log_("Primary connection is healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()))}onControl_(e){const t=Cs(Uo,e);if(Th in e){const s=e[Th];if(t===sI){const r={...s};this.repoInfo_.isUsingEmulator&&(r.h=this.repoInfo_.host),this.onHandshake_(r)}else if(t===Ah){this.log_("recvd end transmission on primary"),this.rx_=this.secondaryConn_;for(let r=0;r<this.pendingDataMessages.length;++r)this.onDataMessage_(this.pendingDataMessages[r]);this.pendingDataMessages=[],this.tryCleanupConnection()}else t===tI?this.onConnectionShutdown_(s):t===vh?this.onReset_(s):t===nI?ga("Server Error: "+s):t===wh?(this.log_("got pong on primary."),this.onPrimaryResponse_(),this.sendPingOnPrimaryIfNecessary_()):ga("Unknown control packet command: "+t)}}onHandshake_(e){const t=e.ts,s=e.v,r=e.h;this.sessionId=e.s,this.repoInfo_.host=r,this.state_===0&&(this.conn_.start(),this.onConnectionEstablished_(this.conn_,t),Pl!==s&&Ke("Protocol version mismatch detected"),this.tryStartUpgrade_())}tryStartUpgrade_(){const e=this.transportManager_.upgradeTransport();e&&this.startUpgrade_(e)}startUpgrade_(e){this.secondaryConn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,this.sessionId),this.secondaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const t=this.connReceiver_(this.secondaryConn_),s=this.disconnReceiver_(this.secondaryConn_);this.secondaryConn_.open(t,s),qs(()=>{this.secondaryConn_&&(this.log_("Timed out trying to upgrade."),this.secondaryConn_.close())},Math.floor(Xw))}onReset_(e){this.log_("Reset packet received.  New host: "+e),this.repoInfo_.host=e,this.state_===1?this.close():(this.closeConnections_(),this.start_())}onConnectionEstablished_(e,t){this.log_("Realtime connection established."),this.conn_=e,this.state_=1,this.onReady_&&(this.onReady_(t,this.sessionId),this.onReady_=null),this.primaryResponsesRequired_===0?(this.log_("Primary connection is healthy."),this.isHealthy_=!0):qs(()=>{this.sendPingOnPrimaryIfNecessary_()},Math.floor(Jw))}sendPingOnPrimaryIfNecessary_(){!this.isHealthy_&&this.state_===1&&(this.log_("sending ping on primary."),this.sendData_({t:"c",d:{t:Rh,d:{}}}))}onSecondaryConnectionLost_(){const e=this.secondaryConn_;this.secondaryConn_=null,(this.tx_===e||this.rx_===e)&&this.close()}onConnectionLost_(e){this.conn_=null,!e&&this.state_===0?(this.log_("Realtime connection failed."),this.repoInfo_.isCacheableHost()&&(cn.remove("host:"+this.repoInfo_.host),this.repoInfo_.internalHost=this.repoInfo_.host)):this.state_===1&&this.log_("Realtime connection lost."),this.close()}onConnectionShutdown_(e){this.log_("Connection shutdown command received. Shutting down..."),this.onKill_&&(this.onKill_(e),this.onKill_=null),this.onDisconnect_=null,this.close()}sendData_(e){if(this.state_!==1)throw"Connection is not connected";this.tx_.send(e)}close(){this.state_!==2&&(this.log_("Closing realtime connection."),this.state_=2,this.closeConnections_(),this.onDisconnect_&&(this.onDisconnect_(),this.onDisconnect_=null))}closeConnections_(){this.log_("Shutting down all connections"),this.conn_&&(this.conn_.close(),this.conn_=null),this.secondaryConn_&&(this.secondaryConn_.close(),this.secondaryConn_=null),this.healthyTimeout_&&(clearTimeout(this.healthyTimeout_),this.healthyTimeout_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ch=32,Sh=768;class ne{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let s=0;for(let r=0;r<this.pieces_.length;r++)this.pieces_[r].length>0&&(this.pieces_[s]=this.pieces_[r],s++);this.pieces_.length=s,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function ee(){return new ne("")}function W(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function Yt(n){return n.pieces_.length-n.pieceNum_}function se(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new ne(n.pieces_,e)}function Dl(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function iI(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function nr(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function Sp(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new ne(e,0)}function _e(n,e){const t=[];for(let s=n.pieceNum_;s<n.pieces_.length;s++)t.push(n.pieces_[s]);if(e instanceof ne)for(let s=e.pieceNum_;s<e.pieces_.length;s++)t.push(e.pieces_[s]);else{const s=e.split("/");for(let r=0;r<s.length;r++)s[r].length>0&&t.push(s[r])}return new ne(t,0)}function H(n){return n.pieceNum_>=n.pieces_.length}function et(n,e){const t=W(n),s=W(e);if(t===null)return e;if(t===s)return et(se(n),se(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function oI(n,e){const t=nr(n,0),s=nr(e,0);for(let r=0;r<t.length&&r<s.length;r++){const i=In(t[r],s[r]);if(i!==0)return i}return t.length===s.length?0:t.length<s.length?-1:1}function bp(n,e){if(Yt(n)!==Yt(e))return!1;for(let t=n.pieceNum_,s=e.pieceNum_;t<=n.pieces_.length;t++,s++)if(n.pieces_[t]!==e.pieces_[s])return!1;return!0}function tt(n,e){let t=n.pieceNum_,s=e.pieceNum_;if(Yt(n)>Yt(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[s])return!1;++t,++s}return!0}class aI{constructor(e,t){this.errorPrefix_=t,this.parts_=nr(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let s=0;s<this.parts_.length;s++)this.byteLength_+=Ai(this.parts_[s]);Pp(this)}}function lI(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=Ai(e),Pp(n)}function cI(n){const e=n.parts_.pop();n.byteLength_-=Ai(e),n.parts_.length>0&&(n.byteLength_-=1)}function Pp(n){if(n.byteLength_>Sh)throw new Error(n.errorPrefix_+"has a key path longer than "+Sh+" bytes ("+n.byteLength_+").");if(n.parts_.length>Ch)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Ch+") or object contains a cycle "+an(n))}function an(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _I(n,e){return In(n.name,e.name)}function Ol(n,e){return In(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vp,Op;function gI(n){Vp=n}function yI(n){Op=n}class EI extends Qi{compare(e,t){const s=e.node.getPriority(),r=t.node.getPriority(),i=s.compareTo(r);return i===0?In(e.name,t.name):i}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return Y.MIN}maxPost(){return new Y(yn,new we("[PRIORITY-POST]",Op))}makePost(e,t){const s=Vp(e);return new Y(t,new we("[PRIORITY-POST]",s))}toString(){return".priority"}}const Pe=new EI;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const II=!0;function ge(n,e=null){if(n===null)return Z.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),V(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new we(t,ge(e))}if(!(n instanceof Array)&&II){const t=[];let s=!1;if(Qe(n,(a,l)=>{if(a.substring(0,1)!=="."){const u=ge(l);u.isEmpty()||(s=s||!u.getPriority().isEmpty(),t.push(new Y(a,u)))}}),t.length===0)return Z.EMPTY_NODE;const i=_i(t,_I,a=>a.name,Ol);if(s){const a=_i(t,Pe.getCompare());return new Z(i,ge(e),new It({".priority":a},{".priority":Pe}))}else return new Z(i,ge(e),It.Default)}else{let t=Z.EMPTY_NODE;return Qe(n,(s,r)=>{if(gt(n,s)&&s.substring(0,1)!=="."){const i=ge(r);(i.isLeafNode()||!i.isEmpty())&&(t=t.updateImmediateChild(s,i))}}),t.updatePriority(ge(e))}}gI(ge);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class RI extends Qi{compare(e,t){const s=e.node.compareTo(t.node);return s===0?In(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Y.MIN}maxPost(){return Y.MAX}makePost(e,t){const s=ge(e);return new Y(t,s)}toString(){return".value"}}const CI=new RI;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function SI(n){return{type:"value",snapshotNode:n}}function bI(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function PI(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function kh(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function NI(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kI{constructor(){this.rootNode_=Z.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VI{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t={...e};return this.last_&&Qe(this.last_,(s,r)=>{t[s]=t[s]-r}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oh=10*1e3,OI=30*1e3,xI=5*60*1e3;class MI{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new VI(e);const s=Oh+(OI-Oh)*Math.random();qs(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;Qe(e,(r,i)=>{i>0&&gt(this.statsToReport_,r)&&(t[r]=i,s=!0)}),s&&this.server_.reportStats(t),qs(this.reportStats_.bind(this),Math.floor(Math.random()*2*xI))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yi{constructor(e,t,s){this.path=e,this.affectedTree=t,this.revert=s,this.type=ut.ACK_USER_WRITE,this.source=xp()}operationForChild(e){if(H(this.path)){if(this.affectedTree.value!=null)return V(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new ne(e));return new yi(ee(),t,this.revert)}}else return V(W(this.path)===e,"operationForChild called for unrelated child."),new yi(se(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ml{constructor(e,t,s){this.node_=e,this.fullyInitialized_=t,this.filtered_=s}isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(e){if(H(e))return this.isFullyInitialized()&&!this.filtered_;const t=W(e);return this.isCompleteForChild(t)}isCompleteForChild(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}getNode(){return this.node_}}function LI(n,e,t,s){const r=[],i=[];return e.forEach(a=>{a.type==="child_changed"&&n.index_.indexedValueChanged(a.oldSnap,a.snapshotNode)&&i.push(NI(a.childName,a.snapshotNode))}),Ps(n,r,"child_removed",e,s,t),Ps(n,r,"child_added",e,s,t),Ps(n,r,"child_moved",i,s,t),Ps(n,r,"child_changed",e,s,t),Ps(n,r,"value",e,s,t),r}function Ps(n,e,t,s,r,i){const a=s.filter(l=>l.type===t);a.sort((l,u)=>UI(n,l,u)),a.forEach(l=>{const u=FI(n,l,i);r.forEach(h=>{h.respondsTo(l.type)&&e.push(h.createEvent(u,n.query_))})})}function FI(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function UI(n,e,t){if(e.childName==null||t.childName==null)throw Xn("Should only compare child_ events.");const s=new Y(e.childName,e.snapshotNode),r=new Y(t.childName,t.snapshotNode);return n.index_.compare(s,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fp(n,e){return{eventCache:n,serverCache:e}}function js(n,e,t,s){return Fp(new Ml(e,t,s),n.serverCache)}function Up(n,e,t,s){return Fp(n.eventCache,new Ml(e,t,s))}function wa(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Tn(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qp(n,e){return Hp(e,n)}function qI(n,e,t,s,r){V(s>n.lastWriteId,"Stacking an older write on top of newer ones"),r===void 0&&(r=!0),n.allWrites.push({path:e,snap:t,writeId:s,visible:r}),r&&(n.visibleWrites=$s(n.visibleWrites,e,t)),n.lastWriteId=s}function jI(n,e){for(let t=0;t<n.allWrites.length;t++){const s=n.allWrites[t];if(s.writeId===e)return s}return null}function $I(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);V(t>=0,"removeWrite called with nonexistent writeId.");const s=n.allWrites[t];n.allWrites.splice(t,1);let r=s.visible,i=!1,a=n.allWrites.length-1;for(;r&&a>=0;){const l=n.allWrites[a];l.visible&&(a>=t&&WI(l,s.path)?r=!1:tt(s.path,l.path)&&(i=!0)),a--}if(r){if(i)return zI(n),!0;if(s.snap)n.visibleWrites=Mh(n.visibleWrites,s.path);else{const l=s.children;Qe(l,u=>{n.visibleWrites=Mh(n.visibleWrites,_e(s.path,u))})}return!0}else return!1}function WI(n,e){if(n.snap)return tt(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&tt(_e(n.path,t),e))return!0;return!1}function zI(n){n.visibleWrites=jp(n.allWrites,HI,ee()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function HI(n){return n.visible}function jp(n,e,t){let s=it.empty();for(let r=0;r<n.length;++r){const i=n[r];if(e(i)){const a=i.path;let l;if(i.snap)tt(t,a)?(l=et(t,a),s=$s(s,l,i.snap)):tt(a,t)&&(l=et(a,t),s=$s(s,ee(),i.snap.getChild(l)));else if(i.children){if(tt(t,a))l=et(t,a),s=xh(s,l,i.children);else if(tt(a,t))if(l=et(a,t),H(l))s=xh(s,ee(),i.children);else{const u=Un(i.children,W(l));if(u){const h=u.getChild(se(l));s=$s(s,ee(),h)}}}else throw Xn("WriteRecord should have .snap or .children")}}return s}function $p(n,e,t,s,r){if(!s&&!r){const i=An(n.visibleWrites,e);if(i!=null)return i;{const a=jt(n.visibleWrites,e);if(Aa(a))return t;if(t==null&&!Ia(a,ee()))return null;{const l=t||Z.EMPTY_NODE;return Qn(a,l)}}}else{const i=jt(n.visibleWrites,e);if(!r&&Aa(i))return t;if(!r&&t==null&&!Ia(i,ee()))return null;{const a=function(h){return(h.visible||r)&&(!s||!~s.indexOf(h.writeId))&&(tt(h.path,e)||tt(e,h.path))},l=jp(n.allWrites,a,e),u=t||Z.EMPTY_NODE;return Qn(l,u)}}}function GI(n,e,t){let s=Z.EMPTY_NODE;const r=An(n.visibleWrites,e);if(r)return r.isLeafNode()||r.forEachChild(Pe,(i,a)=>{s=s.updateImmediateChild(i,a)}),s;if(t){const i=jt(n.visibleWrites,e);return t.forEachChild(Pe,(a,l)=>{const u=Qn(jt(i,new ne(a)),l);s=s.updateImmediateChild(a,u)}),Lh(i).forEach(a=>{s=s.updateImmediateChild(a.name,a.node)}),s}else{const i=jt(n.visibleWrites,e);return Lh(i).forEach(a=>{s=s.updateImmediateChild(a.name,a.node)}),s}}function KI(n,e,t,s,r){V(s||r,"Either existingEventSnap or existingServerSnap must exist");const i=_e(e,t);if(Ia(n.visibleWrites,i))return null;{const a=jt(n.visibleWrites,i);return Aa(a)?r.getChild(t):Qn(a,r.getChild(t))}}function QI(n,e,t,s){const r=_e(e,t),i=An(n.visibleWrites,r);if(i!=null)return i;if(s.isCompleteForChild(t)){const a=jt(n.visibleWrites,r);return Qn(a,s.getNode().getImmediateChild(t))}else return null}function YI(n,e){return An(n.visibleWrites,e)}function XI(n,e,t,s,r,i,a){let l;const u=jt(n.visibleWrites,e),h=An(u,ee());if(h!=null)l=h;else if(t!=null)l=Qn(u,t);else return[];if(l=l.withIndex(a),!l.isEmpty()&&!l.isLeafNode()){const f=[],p=a.getCompare(),m=i?l.getReverseIteratorFrom(s,a):l.getIteratorFrom(s,a);let I=m.getNext();for(;I&&f.length<r;)p(I,s)!==0&&f.push(I),I=m.getNext();return f}else return[]}function JI(){return{visibleWrites:it.empty(),allWrites:[],lastWriteId:-1}}function Ra(n,e,t,s){return $p(n.writeTree,n.treePath,e,t,s)}function Wp(n,e){return GI(n.writeTree,n.treePath,e)}function Fh(n,e,t,s){return KI(n.writeTree,n.treePath,e,t,s)}function Ei(n,e){return YI(n.writeTree,_e(n.treePath,e))}function ZI(n,e,t,s,r,i){return XI(n.writeTree,n.treePath,e,t,s,r,i)}function Ll(n,e,t){return QI(n.writeTree,n.treePath,e,t)}function zp(n,e){return Hp(_e(n.treePath,e),n.writeTree)}function Hp(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eA{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,s=e.childName;V(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),V(s!==".priority","Only non-priority child changes can be tracked.");const r=this.changeMap.get(s);if(r){const i=r.type;if(t==="child_added"&&i==="child_removed")this.changeMap.set(s,kh(s,e.snapshotNode,r.snapshotNode));else if(t==="child_removed"&&i==="child_added")this.changeMap.delete(s);else if(t==="child_removed"&&i==="child_changed")this.changeMap.set(s,PI(s,r.oldSnap));else if(t==="child_changed"&&i==="child_added")this.changeMap.set(s,bI(s,e.snapshotNode));else if(t==="child_changed"&&i==="child_changed")this.changeMap.set(s,kh(s,e.snapshotNode,r.oldSnap));else throw Xn("Illegal combination of changes: "+e+" occurred after "+r)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tA{getCompleteChild(e){return null}getChildAfterChild(e,t,s){return null}}const Gp=new tA;class Fl{constructor(e,t,s=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=s}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new Ml(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ll(this.writes_,e,s)}}getChildAfterChild(e,t,s){const r=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Tn(this.viewCache_),i=ZI(this.writes_,r,t,1,s,e);return i.length===0?null:i[0]}}function nA(n,e){V(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),V(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function sA(n,e,t,s,r){const i=new eA;let a,l;if(t.type===ut.OVERWRITE){const h=t;h.source.fromUser?a=Ca(n,e,h.path,h.snap,s,r,i):(V(h.source.fromServer,"Unknown source."),l=h.source.tagged||e.serverCache.isFiltered()&&!H(h.path),a=Ti(n,e,h.path,h.snap,s,r,l,i))}else if(t.type===ut.MERGE){const h=t;h.source.fromUser?a=iA(n,e,h.path,h.children,s,r,i):(V(h.source.fromServer,"Unknown source."),l=h.source.tagged||e.serverCache.isFiltered(),a=Sa(n,e,h.path,h.children,s,r,l,i))}else if(t.type===ut.ACK_USER_WRITE){const h=t;h.revert?a=lA(n,e,h.path,s,r,i):a=oA(n,e,h.path,h.affectedTree,s,r,i)}else if(t.type===ut.LISTEN_COMPLETE)a=aA(n,e,t.path,s,i);else throw Xn("Unknown operation type: "+t.type);const u=i.getChanges();return rA(e,a,u),{viewCache:a,changes:u}}function rA(n,e,t){const s=e.eventCache;if(s.isFullyInitialized()){const r=s.getNode().isLeafNode()||s.getNode().isEmpty(),i=wa(n);(t.length>0||!n.eventCache.isFullyInitialized()||r&&!s.getNode().equals(i)||!s.getNode().getPriority().equals(i.getPriority()))&&t.push(SI(wa(e)))}}function Kp(n,e,t,s,r,i){const a=e.eventCache;if(Ei(s,t)!=null)return e;{let l,u;if(H(t))if(V(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const h=Tn(e),f=h instanceof Z?h:Z.EMPTY_NODE,p=Wp(s,f);l=n.filter.updateFullNode(e.eventCache.getNode(),p,i)}else{const h=Ra(s,Tn(e));l=n.filter.updateFullNode(e.eventCache.getNode(),h,i)}else{const h=W(t);if(h===".priority"){V(Yt(t)===1,"Can't have a priority with additional path components");const f=a.getNode();u=e.serverCache.getNode();const p=Fh(s,t,f,u);p!=null?l=n.filter.updatePriority(f,p):l=a.getNode()}else{const f=se(t);let p;if(a.isCompleteForChild(h)){u=e.serverCache.getNode();const m=Fh(s,t,a.getNode(),u);m!=null?p=a.getNode().getImmediateChild(h).updateChild(f,m):p=a.getNode().getImmediateChild(h)}else p=Ll(s,h,e.serverCache);p!=null?l=n.filter.updateChild(a.getNode(),h,p,f,r,i):l=a.getNode()}}return js(e,l,a.isFullyInitialized()||H(t),n.filter.filtersNodes())}}function Ti(n,e,t,s,r,i,a,l){const u=e.serverCache;let h;const f=a?n.filter:n.filter.getIndexedFilter();if(H(t))h=f.updateFullNode(u.getNode(),s,null);else if(f.filtersNodes()&&!u.isFiltered()){const I=u.getNode().updateChild(t,s);h=f.updateFullNode(u.getNode(),I,null)}else{const I=W(t);if(!u.isCompleteForPath(t)&&Yt(t)>1)return e;const C=se(t),N=u.getNode().getImmediateChild(I).updateChild(C,s);I===".priority"?h=f.updatePriority(u.getNode(),N):h=f.updateChild(u.getNode(),I,N,C,Gp,null)}const p=Up(e,h,u.isFullyInitialized()||H(t),f.filtersNodes()),m=new Fl(r,p,i);return Kp(n,p,t,r,m,l)}function Ca(n,e,t,s,r,i,a){const l=e.eventCache;let u,h;const f=new Fl(r,e,i);if(H(t))h=n.filter.updateFullNode(e.eventCache.getNode(),s,a),u=js(e,h,!0,n.filter.filtersNodes());else{const p=W(t);if(p===".priority")h=n.filter.updatePriority(e.eventCache.getNode(),s),u=js(e,h,l.isFullyInitialized(),l.isFiltered());else{const m=se(t),I=l.getNode().getImmediateChild(p);let C;if(H(m))C=s;else{const k=f.getCompleteChild(p);k!=null?Dl(m)===".priority"&&k.getChild(Sp(m)).isEmpty()?C=k:C=k.updateChild(m,s):C=Z.EMPTY_NODE}if(I.equals(C))u=e;else{const k=n.filter.updateChild(l.getNode(),p,C,m,f,a);u=js(e,k,l.isFullyInitialized(),n.filter.filtersNodes())}}}return u}function Uh(n,e){return n.eventCache.isCompleteForChild(e)}function iA(n,e,t,s,r,i,a){let l=e;return s.foreach((u,h)=>{const f=_e(t,u);Uh(e,W(f))&&(l=Ca(n,l,f,h,r,i,a))}),s.foreach((u,h)=>{const f=_e(t,u);Uh(e,W(f))||(l=Ca(n,l,f,h,r,i,a))}),l}function Bh(n,e,t){return t.foreach((s,r)=>{e=e.updateChild(s,r)}),e}function Sa(n,e,t,s,r,i,a,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let u=e,h;H(t)?h=s:h=new oe(null).setTree(t,s);const f=e.serverCache.getNode();return h.children.inorderTraversal((p,m)=>{if(f.hasChild(p)){const I=e.serverCache.getNode().getImmediateChild(p),C=Bh(n,I,m);u=Ti(n,u,new ne(p),C,r,i,a,l)}}),h.children.inorderTraversal((p,m)=>{const I=!e.serverCache.isCompleteForChild(p)&&m.value===null;if(!f.hasChild(p)&&!I){const C=e.serverCache.getNode().getImmediateChild(p),k=Bh(n,C,m);u=Ti(n,u,new ne(p),k,r,i,a,l)}}),u}function oA(n,e,t,s,r,i,a){if(Ei(r,t)!=null)return e;const l=e.serverCache.isFiltered(),u=e.serverCache;if(s.value!=null){if(H(t)&&u.isFullyInitialized()||u.isCompleteForPath(t))return Ti(n,e,t,u.getNode().getChild(t),r,i,l,a);if(H(t)){let h=new oe(null);return u.getNode().forEachChild(Fn,(f,p)=>{h=h.set(new ne(f),p)}),Sa(n,e,t,h,r,i,l,a)}else return e}else{let h=new oe(null);return s.foreach((f,p)=>{const m=_e(t,f);u.isCompleteForPath(m)&&(h=h.set(f,u.getNode().getChild(m)))}),Sa(n,e,t,h,r,i,l,a)}}function aA(n,e,t,s,r){const i=e.serverCache,a=Up(e,i.getNode(),i.isFullyInitialized()||H(t),i.isFiltered());return Kp(n,a,t,s,Gp,r)}function lA(n,e,t,s,r,i){let a;if(Ei(s,t)!=null)return e;{const l=new Fl(s,e,r),u=e.eventCache.getNode();let h;if(H(t)||W(t)===".priority"){let f;if(e.serverCache.isFullyInitialized())f=Ra(s,Tn(e));else{const p=e.serverCache.getNode();V(p instanceof Z,"serverChildren would be complete if leaf node"),f=Wp(s,p)}f=f,h=n.filter.updateFullNode(u,f,i)}else{const f=W(t);let p=Ll(s,f,e.serverCache);p==null&&e.serverCache.isCompleteForChild(f)&&(p=u.getImmediateChild(f)),p!=null?h=n.filter.updateChild(u,f,p,se(t),l,i):e.eventCache.getNode().hasChild(f)?h=n.filter.updateChild(u,f,Z.EMPTY_NODE,se(t),l,i):h=u,h.isEmpty()&&e.serverCache.isFullyInitialized()&&(a=Ra(s,Tn(e)),a.isLeafNode()&&(h=n.filter.updateFullNode(h,a,i)))}return a=e.serverCache.isFullyInitialized()||Ei(s,ee())!=null,js(e,h,a,n.filter.filtersNodes())}}function cA(n,e){const t=Tn(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!H(e)&&!t.getImmediateChild(W(e)).isEmpty())?t.getChild(e):null}function qh(n,e,t,s){e.type===ut.MERGE&&e.source.queryId!==null&&(V(Tn(n.viewCache_),"We should always have a full cache before handling merges"),V(wa(n.viewCache_),"Missing event cache, even though we have a server cache"));const r=n.viewCache_,i=sA(n.processor_,r,e,t,s);return nA(n.processor_,i.viewCache),V(i.viewCache.serverCache.isFullyInitialized()||!r.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=i.viewCache,uA(n,i.changes,i.viewCache.eventCache.getNode())}function uA(n,e,t,s){const r=n.eventRegistrations_;return LI(n.eventGenerator_,e,t,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let jh;function hA(n){V(!jh,"__referenceConstructor has already been defined"),jh=n}function Ul(n,e,t,s){const r=e.source.queryId;if(r!==null){const i=n.views.get(r);return V(i!=null,"SyncTree gave us an op for an invalid query."),qh(i,e,t,s)}else{let i=[];for(const a of n.views.values())i=i.concat(qh(a,e,t,s));return i}}function Bl(n,e){let t=null;for(const s of n.views.values())t=t||cA(s,e);return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $h;function dA(n){V(!$h,"__referenceConstructor has already been defined"),$h=n}class Wh{constructor(e){this.listenProvider_=e,this.syncPointTree_=new oe(null),this.pendingWriteTree_=JI(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Qp(n,e,t,s,r){return qI(n.pendingWriteTree_,e,t,s,r),r?Xi(n,new En(xp(),e,t)):[]}function un(n,e,t=!1){const s=jI(n.pendingWriteTree_,e);if($I(n.pendingWriteTree_,e)){let i=new oe(null);return s.snap!=null?i=i.set(ee(),!0):Qe(s.children,a=>{i=i.set(new ne(a),!0)}),Xi(n,new yi(s.path,i,t))}else return[]}function Yi(n,e,t){return Xi(n,new En(Mp(),e,t))}function fA(n,e,t){const s=oe.fromObject(t);return Xi(n,new sr(Mp(),e,s))}function pA(n,e,t,s){const r=Jp(n,s);if(r!=null){const i=Zp(r),a=i.path,l=i.queryId,u=et(a,e),h=new En(Lp(l),u,t);return e_(n,a,h)}else return[]}function _A(n,e,t,s){const r=Jp(n,s);if(r){const i=Zp(r),a=i.path,l=i.queryId,u=et(a,e),h=oe.fromObject(t),f=new sr(Lp(l),u,h);return e_(n,a,f)}else return[]}function ql(n,e,t){const r=n.pendingWriteTree_,i=n.syncPointTree_.findOnPath(e,(a,l)=>{const u=et(a,e),h=Bl(l,u);if(h)return h});return $p(r,e,i,t,!0)}function Xi(n,e){return Yp(e,n.syncPointTree_,null,qp(n.pendingWriteTree_,ee()))}function Yp(n,e,t,s){if(H(n.path))return Xp(n,e,t,s);{const r=e.get(ee());t==null&&r!=null&&(t=Bl(r,ee()));let i=[];const a=W(n.path),l=n.operationForChild(a),u=e.children.get(a);if(u&&l){const h=t?t.getImmediateChild(a):null,f=zp(s,a);i=i.concat(Yp(l,u,h,f))}return r&&(i=i.concat(Ul(r,n,s,t))),i}}function Xp(n,e,t,s){const r=e.get(ee());t==null&&r!=null&&(t=Bl(r,ee()));let i=[];return e.children.inorderTraversal((a,l)=>{const u=t?t.getImmediateChild(a):null,h=zp(s,a),f=n.operationForChild(a);f&&(i=i.concat(Xp(f,l,u,h)))}),r&&(i=i.concat(Ul(r,n,s,t))),i}function Jp(n,e){return n.tagToQueryMap.get(e)}function Zp(n){const e=n.indexOf("$");return V(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new ne(n.substr(0,e))}}function e_(n,e,t){const s=n.syncPointTree_.get(e);V(s,"Missing sync point for query tag that we're tracking");const r=qp(n.pendingWriteTree_,e);return Ul(s,t,r,null)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jl{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new jl(t)}node(){return this.node_}}class $l{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=_e(this.path_,e);return new $l(this.syncTree_,t)}node(){return ql(this.syncTree_,this.path_)}}const mA=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},zh=function(n,e,t){if(!n||typeof n!="object")return n;if(V(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return gA(n[".sv"],e,t);if(typeof n[".sv"]=="object")return yA(n[".sv"],e);V(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},gA=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:V(!1,"Unexpected server value: "+n)}},yA=function(n,e,t){n.hasOwnProperty("increment")||V(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const s=n.increment;typeof s!="number"&&V(!1,"Unexpected increment value: "+s);const r=e.node();if(V(r!==null&&typeof r<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return s;const a=r.getValue();return typeof a!="number"?s:a+s},EA=function(n,e,t,s){return Wl(e,new $l(t,n),s)},t_=function(n,e,t){return Wl(n,new jl(e),t)};function Wl(n,e,t){const s=n.getPriority().val(),r=zh(s,e.getImmediateChild(".priority"),t);let i;if(n.isLeafNode()){const a=n,l=zh(a.getValue(),e,t);return l!==a.getValue()||r!==a.getPriority().val()?new we(l,ge(r)):n}else{const a=n;return i=a,r!==a.getPriority().val()&&(i=i.updatePriority(new we(r))),a.forEachChild(Pe,(l,u)=>{const h=Wl(u,e.getImmediateChild(l),t);h!==u&&(i=i.updateImmediateChild(l,h))}),i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IA=/[\[\].#$\/\u0000-\u001F\u007F]/,AA=/[\[\].#$\u0000-\u001F\u007F]/,jo=10*1024*1024,Gl=function(n){return typeof n=="string"&&n.length!==0&&!IA.test(n)},i_=function(n){return typeof n=="string"&&n.length!==0&&!AA.test(n)},RA=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),i_(n)},o_=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Ki(n)||n&&typeof n=="object"&&gt(n,".sv")},Pa=function(n,e,t,s){Zi(Bn(n,"value"),e,t)},Zi=function(n,e,t){const s=t instanceof ne?new aI(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+an(s));if(typeof e=="function")throw new Error(n+"contains a function "+an(s)+" with contents = "+e.toString());if(Ki(e))throw new Error(n+"contains "+e.toString()+" "+an(s));if(typeof e=="string"&&e.length>jo/3&&Ai(e)>jo)throw new Error(n+"contains a string greater than "+jo+" utf8 bytes "+an(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let r=!1,i=!1;if(Qe(e,(a,l)=>{if(a===".value")r=!0;else if(a!==".priority"&&a!==".sv"&&(i=!0,!Gl(a)))throw new Error(n+" contains an invalid key ("+a+") "+an(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);lI(s,a),Zi(n,l,s),cI(s)}),r&&i)throw new Error(n+' contains ".value" child '+an(s)+" in addition to actual children.")}},CA=function(n,e){let t,s;for(t=0;t<e.length;t++){s=e[t];const i=nr(s);for(let a=0;a<i.length;a++)if(!(i[a]===".priority"&&a===i.length-1)){if(!Gl(i[a]))throw new Error(n+"contains an invalid key ("+i[a]+") in path "+s.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(oI);let r=null;for(t=0;t<e.length;t++){if(s=e[t],r!==null&&tt(r,s))throw new Error(n+"contains a path "+r.toString()+" that is ancestor of another path "+s.toString());r=s}},SA=function(n,e,t,s){const r=Bn(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(r+" must be an object containing the children to replace.");const i=[];Qe(e,(a,l)=>{const u=new ne(a);if(Zi(r,l,_e(t,u)),Dl(u)===".priority"&&!o_(l))throw new Error(r+"contains an invalid value for '"+u.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");i.push(u)}),CA(r,i)},bA=function(n,e,t){if(Ki(e))throw new Error(Bn(n,"priority")+"is "+e.toString()+", but must be a valid Firebase priority (a string, finite number, server value, or null).");if(!o_(e))throw new Error(Bn(n,"priority")+"must be a valid Firebase priority (a string, finite number, server value, or null).")},a_=function(n,e,t,s){if(!i_(t))throw new Error(Bn(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},PA=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),a_(n,e,t)},xn=function(n,e){if(W(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},NA=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Gl(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!RA(t))throw new Error(Bn(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kA{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function l_(n,e){let t=null;for(let s=0;s<e.length;s++){const r=e[s],i=r.getPath();t!==null&&!bp(i,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:i}),t.events.push(r)}t&&n.eventLists_.push(t)}function Pt(n,e,t){l_(n,t),DA(n,s=>tt(s,e)||tt(e,s))}function DA(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const r=n.eventLists_[s];if(r){const i=r.path;e(i)?(VA(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function VA(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();Bs&&Ce("event: "+t.toString()),is(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OA="repo_interrupt",xA=25;class MA{constructor(e,t,s,r){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=s,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new kA,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=gi(),this.transactionQueueTree_=new zl,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function LA(n,e,t){if(n.stats_=Nl(n.repoInfo_),n.forceRestClient_||kw())n.server_=new mi(n.repoInfo_,(s,r,i,a)=>{Hh(n,s,r,i,a)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Gh(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Se(t)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}n.persistentConnection_=new At(n.repoInfo_,e,(s,r,i,a)=>{Hh(n,s,r,i,a)},s=>{Gh(n,s)},s=>{UA(n,s)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(s=>{n.server_.refreshAuthToken(s)}),n.appCheckProvider_.addTokenChangeListener(s=>{n.server_.refreshAppCheckToken(s.token)}),n.statsReporter_=Mw(n.repoInfo_,()=>new MI(n.stats_,n.server_)),n.infoData_=new kI,n.infoSyncTree_=new Wh({startListening:(s,r,i,a)=>{let l=[];const u=n.infoData_.getNode(s._path);return u.isEmpty()||(l=Yi(n.infoSyncTree_,s._path,u),setTimeout(()=>{a("ok")},0)),l},stopListening:()=>{}}),Ql(n,"connected",!1),n.serverSyncTree_=new Wh({startListening:(s,r,i,a)=>(n.server_.listen(s,i,r,(l,u)=>{const h=a(l,u);Pt(n.eventQueue_,s._path,h)}),[]),stopListening:(s,r)=>{n.server_.unlisten(s,r)}})}function FA(n){const t=n.infoData_.getNode(new ne(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Kl(n){return mA({timestamp:FA(n)})}function Hh(n,e,t,s,r){n.dataUpdateCount++;const i=new ne(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let a=[];if(r)if(s){const u=Jr(t,h=>ge(h));a=_A(n.serverSyncTree_,i,u,r)}else{const u=ge(t);a=pA(n.serverSyncTree_,i,u,r)}else if(s){const u=Jr(t,h=>ge(h));a=fA(n.serverSyncTree_,i,u)}else{const u=ge(t);a=Yi(n.serverSyncTree_,i,u)}let l=i;a.length>0&&(l=eo(n,i)),Pt(n.eventQueue_,l,a)}function Gh(n,e){Ql(n,"connected",e),e===!1&&qA(n)}function UA(n,e){Qe(e,(t,s)=>{Ql(n,t,s)})}function Ql(n,e,t){const s=new ne("/.info/"+e),r=ge(t);n.infoData_.updateSnapshot(s,r);const i=Yi(n.infoSyncTree_,s,r);Pt(n.eventQueue_,s,i)}function c_(n){return n.nextWriteId_++}function BA(n,e,t,s,r){Yl(n,"set",{path:e.toString(),value:t,priority:s});const i=Kl(n),a=ge(t,s),l=ql(n.serverSyncTree_,e),u=t_(a,l,i),h=c_(n),f=Qp(n.serverSyncTree_,e,u,h,!0);l_(n.eventQueue_,f),n.server_.put(e.toString(),a.val(!0),(m,I)=>{const C=m==="ok";C||Ke("set at "+e+" failed: "+m);const k=un(n.serverSyncTree_,h,!C);Pt(n.eventQueue_,e,k),Yn(n,r,m,I)});const p=p_(n,e);eo(n,p),Pt(n.eventQueue_,p,[])}function qA(n){Yl(n,"onDisconnectEvents");const e=Kl(n),t=gi();va(n.onDisconnect_,ee(),(r,i)=>{const a=EA(r,i,n.serverSyncTree_,e);os(t,r,a)});let s=[];va(t,ee(),(r,i)=>{s=s.concat(Yi(n.serverSyncTree_,r,i));const a=p_(n,r);eo(n,a)}),n.onDisconnect_=gi(),Pt(n.eventQueue_,ee(),s)}function jA(n,e,t){n.server_.onDisconnectCancel(e.toString(),(s,r)=>{s==="ok"&&Ta(n.onDisconnect_,e),Yn(n,t,s,r)})}function Kh(n,e,t,s){const r=ge(t);n.server_.onDisconnectPut(e.toString(),r.val(!0),(i,a)=>{i==="ok"&&os(n.onDisconnect_,e,r),Yn(n,s,i,a)})}function $A(n,e,t,s,r){const i=ge(t,s);n.server_.onDisconnectPut(e.toString(),i.val(!0),(a,l)=>{a==="ok"&&os(n.onDisconnect_,e,i),Yn(n,r,a,l)})}function WA(n,e,t,s){if(zo(t)){Ce("onDisconnect().update() called with empty data.  Don't do anything."),Yn(n,s,"ok",void 0);return}n.server_.onDisconnectMerge(e.toString(),t,(r,i)=>{r==="ok"&&Qe(t,(a,l)=>{const u=ge(l);os(n.onDisconnect_,_e(e,a),u)}),Yn(n,s,r,i)})}function zA(n){n.persistentConnection_&&n.persistentConnection_.interrupt(OA)}function Yl(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),Ce(t,...e)}function Yn(n,e,t,s){e&&is(()=>{if(t==="ok")e(null);else{const r=(t||"error").toUpperCase();let i=r;s&&(i+=": "+s);const a=new Error(i);a.code=r,e(a)}})}function u_(n,e,t){return ql(n.serverSyncTree_,e,t)||Z.EMPTY_NODE}function Xl(n,e=n.transactionQueueTree_){if(e||to(n,e),as(e)){const t=d_(n,e);V(t.length>0,"Sending zero length transaction queue"),t.every(r=>r.status===0)&&HA(n,_r(e),t)}else s_(e)&&Ji(e,t=>{Xl(n,t)})}function HA(n,e,t){const s=t.map(h=>h.currentWriteId),r=u_(n,e,s);let i=r;const a=r.hash();for(let h=0;h<t.length;h++){const f=t[h];V(f.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),f.status=1,f.retryCount++;const p=et(e,f.path);i=i.updateChild(p,f.currentOutputSnapshotRaw)}const l=i.val(!0),u=e;n.server_.put(u.toString(),l,h=>{Yl(n,"transaction put response",{path:u.toString(),status:h});let f=[];if(h==="ok"){const p=[];for(let m=0;m<t.length;m++)t[m].status=2,f=f.concat(un(n.serverSyncTree_,t[m].currentWriteId)),t[m].onComplete&&p.push(()=>t[m].onComplete(null,!0,t[m].currentOutputSnapshotResolved)),t[m].unwatcher();to(n,Hl(n.transactionQueueTree_,e)),Xl(n,n.transactionQueueTree_),Pt(n.eventQueue_,e,f);for(let m=0;m<p.length;m++)is(p[m])}else{if(h==="datastale")for(let p=0;p<t.length;p++)t[p].status===3?t[p].status=4:t[p].status=0;else{Ke("transaction at "+u.toString()+" failed: "+h);for(let p=0;p<t.length;p++)t[p].status=4,t[p].abortReason=h}eo(n,e)}},a)}function eo(n,e){const t=h_(n,e),s=_r(t),r=d_(n,t);return GA(n,r,s),s}function GA(n,e,t){if(e.length===0)return;const s=[];let r=[];const a=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const u=e[l],h=et(t,u.path);let f=!1,p;if(V(h!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),u.status===4)f=!0,p=u.abortReason,r=r.concat(un(n.serverSyncTree_,u.currentWriteId,!0));else if(u.status===0)if(u.retryCount>=xA)f=!0,p="maxretry",r=r.concat(un(n.serverSyncTree_,u.currentWriteId,!0));else{const m=u_(n,u.path,a);u.currentInputSnapshot=m;const I=e[l].update(m.val());if(I!==void 0){Zi("transaction failed: Data returned ",I,u.path);let C=ge(I);typeof I=="object"&&I!=null&&gt(I,".priority")||(C=C.updatePriority(m.getPriority()));const N=u.currentWriteId,B=Kl(n),L=t_(C,m,B);u.currentOutputSnapshotRaw=C,u.currentOutputSnapshotResolved=L,u.currentWriteId=c_(n),a.splice(a.indexOf(N),1),r=r.concat(Qp(n.serverSyncTree_,u.path,L,u.currentWriteId,u.applyLocally)),r=r.concat(un(n.serverSyncTree_,N,!0))}else f=!0,p="nodata",r=r.concat(un(n.serverSyncTree_,u.currentWriteId,!0))}Pt(n.eventQueue_,t,r),r=[],f&&(e[l].status=2,function(m){setTimeout(m,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(p==="nodata"?s.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):s.push(()=>e[l].onComplete(new Error(p),!1,null))))}to(n,n.transactionQueueTree_);for(let l=0;l<s.length;l++)is(s[l]);Xl(n,n.transactionQueueTree_)}function h_(n,e){let t,s=n.transactionQueueTree_;for(t=W(e);t!==null&&as(s)===void 0;)s=Hl(s,t),e=se(e),t=W(e);return s}function d_(n,e){const t=[];return f_(n,e,t),t.sort((s,r)=>s.order-r.order),t}function f_(n,e,t){const s=as(e);if(s)for(let r=0;r<s.length;r++)t.push(s[r]);Ji(e,r=>{f_(n,r,t)})}function to(n,e){const t=as(e);if(t){let s=0;for(let r=0;r<t.length;r++)t[r].status!==2&&(t[s]=t[r],s++);t.length=s,n_(e,t.length>0?t:void 0)}Ji(e,s=>{to(n,s)})}function p_(n,e){const t=_r(h_(n,e)),s=Hl(n.transactionQueueTree_,e);return vA(s,r=>{$o(n,r)}),$o(n,s),r_(s,r=>{$o(n,r)}),t}function $o(n,e){const t=as(e);if(t){const s=[];let r=[],i=-1;for(let a=0;a<t.length;a++)t[a].status===3||(t[a].status===1?(V(i===a-1,"All SENT items should be at beginning of queue."),i=a,t[a].status=3,t[a].abortReason="set"):(V(t[a].status===0,"Unexpected transaction status in abort"),t[a].unwatcher(),r=r.concat(un(n.serverSyncTree_,t[a].currentWriteId,!0)),t[a].onComplete&&s.push(t[a].onComplete.bind(null,new Error("set"),!1,null))));i===-1?n_(e,void 0):t.length=i+1,Pt(n.eventQueue_,_r(e),r);for(let a=0;a<s.length;a++)is(s[a])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function KA(n){let e="";const t=n.split("/");for(let s=0;s<t.length;s++)if(t[s].length>0){let r=t[s];try{r=decodeURIComponent(r.replace(/\+/g," "))}catch{}e+="/"+r}return e}function QA(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const s=t.split("=");s.length===2?e[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):Ke(`Invalid query segment '${t}' in query '${n}'`)}return e}const Qh=function(n,e){const t=YA(n),s=t.namespace;t.domain==="firebase.com"&&bt(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!s||s==="undefined")&&t.domain!=="localhost"&&bt("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||Iw();const r=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new yp(t.host,t.secure,s,r,e,"",s!==t.subdomain),path:new ne(t.pathString)}},YA=function(n){let e="",t="",s="",r="",i="",a=!0,l="https",u=443;if(typeof n=="string"){let h=n.indexOf("//");h>=0&&(l=n.substring(0,h-1),n=n.substring(h+2));let f=n.indexOf("/");f===-1&&(f=n.length);let p=n.indexOf("?");p===-1&&(p=n.length),e=n.substring(0,Math.min(f,p)),f<p&&(r=KA(n.substring(f,p)));const m=QA(n.substring(Math.min(n.length,p)));h=e.indexOf(":"),h>=0?(a=l==="https"||l==="wss",u=parseInt(e.substring(h+1),10)):h=e.length;const I=e.slice(0,h);if(I.toLowerCase()==="localhost")t="localhost";else if(I.split(".").length<=2)t=I;else{const C=e.indexOf(".");s=e.substring(0,C).toLowerCase(),t=e.substring(C+1),i=s}"ns"in m&&(i=m.ns)}return{host:e,port:u,domain:t,subdomain:s,secure:a,scheme:l,pathString:r,namespace:i}};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XA{constructor(e,t){this._repo=e,this._path=t}cancel(){const e=new wt;return jA(this._repo,this._path,e.wrapCallback(()=>{})),e.promise}remove(){xn("OnDisconnect.remove",this._path);const e=new wt;return Kh(this._repo,this._path,null,e.wrapCallback(()=>{})),e.promise}set(e){xn("OnDisconnect.set",this._path),Pa("OnDisconnect.set",e,this._path);const t=new wt;return Kh(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}setWithPriority(e,t){xn("OnDisconnect.setWithPriority",this._path),Pa("OnDisconnect.setWithPriority",e,this._path),bA("OnDisconnect.setWithPriority",t);const s=new wt;return $A(this._repo,this._path,e,t,s.wrapCallback(()=>{})),s.promise}update(e){xn("OnDisconnect.update",this._path),SA("OnDisconnect.update",e,this._path);const t=new wt;return WA(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jl{constructor(e,t,s,r){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=r}get key(){return H(this._path)?null:Dl(this._path)}get ref(){return new Rn(this._repo,this._path)}get _queryIdentifier(){const e=Vh(this._queryParams),t=bl(e);return t==="{}"?"default":t}get _queryObject(){return Vh(this._queryParams)}isEqual(e){if(e=le(e),!(e instanceof Jl))return!1;const t=this._repo===e._repo,s=bp(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&s&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+iI(this._path)}}class Rn extends Jl{constructor(e,t){super(e,t,new xl,!1)}get parent(){const e=Sp(this._path);return e===null?null:new Rn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}function OR(n,e){return n=le(n),n._checkNotDeleted("ref"),e!==void 0?JA(n._root,e):n._root}function JA(n,e){return n=le(n),W(n._path)===null?PA("child","path",e):a_("child","path",e),new Rn(n._repo,_e(n._path,e))}function xR(n){return n=le(n),new XA(n._repo,n._path)}function MR(n){return xn("remove",n._path),ZA(n,null)}function ZA(n,e){n=le(n),xn("set",n._path),Pa("set",e,n._path);const t=new wt;return BA(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}hA(Rn);dA(Rn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eR="FIREBASE_DATABASE_EMULATOR_HOST",Na={};let tR=!1;function nR(n,e,t,s){const r=e.lastIndexOf(":"),i=e.substring(0,r),a=Xt(i);n.repoInfo_=new yp(e,a,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),s&&(n.authTokenProvider_=s)}function sR(n,e,t,s,r){let i=s||n.options.databaseURL;i===void 0&&(n.options.projectId||bt("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ce("Using default host for project ",n.options.projectId),i=`${n.options.projectId}-default-rtdb.firebaseio.com`);let a=Qh(i,r),l=a.repoInfo,u;typeof process<"u"&&ph&&(u=ph[eR]),u?(i=`http://${u}?ns=${l.namespace}`,a=Qh(i,r),l=a.repoInfo):a.repoInfo.secure;const h=new Vw(n.name,n.options,e);NA("Invalid Firebase Database URL",a),H(a.path)||bt("Database URL must point to the root of a Firebase Database (not including a child path).");const f=iR(l,n,h,new Dw(n,t));return new oR(f,n)}function rR(n,e){const t=Na[e];(!t||t[n.key]!==n)&&bt(`Database ${e}(${n.repoInfo_}) has already been deleted.`),zA(n),delete t[n.key]}function iR(n,e,t,s){let r=Na[e.name];r||(r={},Na[e.name]=r);let i=r[n.toURLString()];return i&&bt("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),i=new MA(n,tR,t,s),r[n.toURLString()]=i,i}class oR{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(LA(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Rn(this._repo,ee())),this._rootInternal}_delete(){return this._rootInternal!==null&&(rR(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&bt("Cannot call "+e+" on a deleted database.")}}function aR(n=Si(),e){const t=Ri(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const s=vi("database");s&&lR(t,...s)}return t}function lR(n,e,t,s={}){n=le(n),n._checkNotDeleted("useEmulator");const r=`${e}:${t}`,i=n._repoInternal;if(n._instanceStarted){if(r===n._repoInternal.repoInfo_.host&&zs(s,i.repoInfo_.emulatorOptions))return;bt("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let a;if(i.repoInfo_.nodeAdmin)s.mockUserToken&&bt('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),a=new Yr(Yr.OWNER);else if(s.mockUserToken){const l=typeof s.mockUserToken=="string"?s.mockUserToken:Va(s.mockUserToken,n.app.options.projectId);a=new Yr(l)}Xt(e)&&(wi(e),Ii("Database",!0)),nR(i,r,s,a)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cR(n){gw(xa),pn(new $t("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),i=e.getProvider("app-check-internal");return sR(s,r,i,t)},"PUBLIC").setMultipleInstances(!0)),nt(_h,mh,n),nt(_h,mh,"esm2020")}At.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};At.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};cR();const uR={apiKey:"AIzaSyBdE26vC0UAprsdTgBcmYrVuO67ZbccMTA",authDomain:"apps-script-api-443402.firebaseapp.com",databaseURL:"https://apps-script-api-443402-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"apps-script-api-443402",storageBucket:"apps-script-api-443402.appspot.com",messagingSenderId:"46453918785",appId:"1:46453918785:web:a3c386def8dfe69f768ac0",measurementId:"G-TCZ9TL8FLW"},no=id(uR),LR=AT(no,"anxi-app"),FR=Hv(no),UR=_w(no),BR=aR(no);export{RR as A,ER as B,BR as C,ae as T,yR as a,TR as b,pR as c,IT as d,vR as e,UR as f,SR as g,VR as h,_R as i,PR as j,FR as k,NR as l,kR as m,LR as n,CR as o,OR as p,mR as q,DR as r,bR as s,xR as t,IR as u,ZA as v,gR as w,MR as x,wR as y,AR as z};
