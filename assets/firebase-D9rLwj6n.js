import{q as Lm}from"./vendor-cpyZX3vi.js";const xm=()=>{};var Iu={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ZC={".sv":"timestamp"};function lS(){return ZC}bt.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};bt.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};JC();const eR={apiKey:"AIzaSyBdE26vC0UAprsdTgBcmYrVuO67ZbccMTA",authDomain:"apps-script-api-443402.firebaseapp.com",databaseURL:"https://apps-script-api-443402-default-rtdb.asia-east1.firebasedatabase.app",projectId:"apps-script-api-443402",storageBucket:"apps-script-api-443402.appspot.com",messagingSenderId:"46453918785",appId:"1:46453918785:web:a3c386def8dfe69f768ac0",measurementId:"G-TCZ9TL8FLW"},To=Md(eR),uS=pv(To,"anxi-app"),hS=LI(To),dS=iw(To,"asia-east1"),fS=YC(To);function H_(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const tR=H_,G_=new pr("auth","Firebase",H_());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
