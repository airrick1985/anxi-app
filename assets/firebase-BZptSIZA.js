import{q as dg}from"./vendor-Dts9G3Wx.js";const fg=()=>{};var Ju={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xg{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Jg(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function Jg(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Va="@firebase/app",th="0.14.5";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uy(n){kt(new vt("platform-logger",e=>new Xg(e),"PRIVATE")),kt(new vt("heartbeat",e=>new xy(e),"PRIVATE")),Ye(Va,th,n),Ye(Va,th,"esm2020"),Ye("fire-js","")}Uy("");var By="firebase",qy="12.5.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YR={".sv":"timestamp"};function cb(){return YR}Pt.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};Pt.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};QR();const XR={apiKey:"AIzaSyBdE26vC0UAprsdTgBcmYrVuO67ZbccMTA",authDomain:"apps-script-api-443402.firebaseapp.com",databaseURL:"https://apps-script-api-443402-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"apps-script-api-443402",storageBucket:"apps-script-api-443402.firebasestorage.app",messagingSenderId:"46453918785",appId:"1:46453918785:web:a3c386def8dfe69f768ac0",measurementId:"G-TCZ9TL8FLW"},$o=hf(XR),ub=Wv($o,"anxi-app"),hb=dw($o),db=xw($o,"asia-east1"),fb=GR($o);function Im(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const JR=Im,wm=new Ci("auth","Firebase",Im());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new qi(5e3,15e3);var tf="@firebase/auth",nf="1.11.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OS=300;wg("authIdTokenMaxAge");DS("Browser");export{KS as A,$S as B,cb as C,fb as D,ab as E,ob as F,lb as G,ce as T,jv as a,jS as b,LS as c,ub as d,xw as e,db as f,WS as g,nb as h,qS as i,FS as j,JS as k,hb as l,ZS as m,eb as n,QS as o,YS as p,US as q,tb as r,XS as s,sb as t,HS as u,ib as v,BS as w,rb as x,zS as y,GS as z};
